...
80100b70:	e8 1b 5e 00 00       	call   80106990 <freevm>
  if(ip){
    iunlockput(ip);
    end_op();
  }
...
80100bab:	e8 10 5f 00 00       	call   80106ac0 <clearpteu>
  sp = USERSTACK;
...
80100d18:	e8 f3 58 00 00       	call   80106610 <switchuvm>
  freevm(oldpgdir);
80100d1d:	89 34 24             	mov    %esi,(%esp)
80100d20:	e8 6b 5c 00 00       	call   80106990 <freevm>
  return 0;
...
801034e9:	0f 84 81 00 00 00    	je     80103570 <allocproc+0xb0>
    if(p->state == UNUSED)
801034ef:	8b 43 10             	mov    0x10(%ebx),%eax
...
found:
  p->state = EMBRYO;
80103502:	c7 43 10 01 00 00 00 	movl   $0x1,0x10(%ebx)
  p->pid = nextpid++;
  p->pgcount = 1;
80103509:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
  release(&ptable.lock);
  return 0;
...
80103519:	89 43 14             	mov    %eax,0x14(%ebx)
  p->pgcount = 1;

  release(&ptable.lock);
8010351c:	e8 0f 0d 00 00       	call   80104230 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
80103521:	e8 7a ef ff ff       	call   801024a0 <kalloc>
80103526:	85 c0                	test   %eax,%eax
80103528:	89 43 0c             	mov    %eax,0xc(%ebx)
...
80103533:	05 9c 0f 00 00       	add    $0xf9c,%eax
  ...
  // Leave room for trap frame.
  sp -= sizeof *p->tf;
80103538:	89 53 1c             	mov    %edx,0x1c(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
8010353b:	c7 40 14 85 54 10 80 	movl   $0x80105485,0x14(%eax)
...
80103552:	89 04 24             	mov    %eax,(%esp)
  ...
  *(uint*)sp = (uint)trapret;
  ...
  sp -= sizeof *p->context;
  p->context = (struct context*)sp;
80103555:	89 43 20             	mov    %eax,0x20(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103558:	e8 23 0d 00 00       	call   80104280 <memset>
  p->context->eip = (uint)forkret;
8010355d:	8b 43 20             	mov    0x20(%ebx),%eax
...
80103577:	e8 b4 0c 00 00       	call   80104230 <release>
  p->context = (struct context*)sp;
  memset(p->context, 0, sizeof *p->context);
  p->context->eip = (uint)forkret;
...
80103583:	c3                   	ret    
  ...
  if((p->kstack = kalloc()) == 0){
    p->state = UNUSED;
80103584:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
    return 0;
...
80103809:	e8 62 30 00 00       	call   80106870 <allocuvm>
...
80103f19:	c7 04 24 41 6e 10 80 	movl   $0x80106e41,(%esp)
...
8010468d:	8b 14 85 e0 74 10 80 	mov    -0x7fef8b20(,%eax,4),%edx
...
801046b6:	c7 04 24 b1 74 10 80 	movl   $0x801074b1,(%esp)
...
80104840:	c7 44 24 04 5c 75 10 	movl   $0x8010755c,0x4(%esp)
80104847:	80 
...
8010485b:	c7 44 24 04 5b 75 10 	movl   $0x8010755b,0x4(%esp)
80104862:	80 
...
80104871:	79 89                	jns    801047fc <create+0xdc>
      panic("create dots");
80104873:	c7 04 24 4f 75 10 80 	movl   $0x8010754f,(%esp)
8010487a:	e8 e1 ba ff ff       	call   80100360 <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
    panic("create: dirlink");
8010487f:	c7 04 24 5e 75 10 80 	movl   $0x8010755e,(%esp)
80104886:	e8 d5 ba ff ff       	call   80100360 <panic>
  ...
  if((ip = ialloc(dp->dev, type)) == 0)
    panic("create: ialloc");
8010488b:	c7 04 24 40 75 10 80 	movl   $0x80107540,(%esp)
...
80104c31:	c7 44 24 04 5c 75 10 	movl   $0x8010755c,0x4(%esp)
80104c38:	80 
...
80104c49:	c7 44 24 04 5b 75 10 	movl   $0x8010755b,0x4(%esp)
80104c50:	80 
...
80104d98:	e9 48 ff ff ff       	jmp    80104ce5 <sys_unlink+0x105>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
80104d9d:	c7 04 24 80 75 10 80 	movl   $0x80107580,(%esp)
80104da4:	e8 b7 b5 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("unlink: writei");
80104da9:	c7 04 24 92 75 10 80 	movl   $0x80107592,(%esp)
80104db0:	e8 ab b5 ff ff       	call   80100360 <panic>
  ...
  if(ip->nlink < 1)
    panic("unlink: nlink < 1");
80104db5:	c7 04 24 6e 75 10 80 	movl   $0x8010756e,(%esp)
...
80105269:	e8 62 1b 00 00       	call   80106dd0 <shm_open>
}
8010526e:	c9                   	leave  
8010526f:	c3                   	ret    
int sys_shm_open(void) {
...
801052a3:	e8 38 1b 00 00       	call   80106de0 <shm_close>
}
801052a8:	c9                   	leave  
801052a9:	c3                   	ret    
...
801054e9:	c7 44 24 04 a1 75 10 	movl   $0x801075a1,0x4(%esp)
801054f0:	80 
...
80105580:	ff 24 85 48 76 10 80 	jmp    *-0x7fef89b8(,%eax,4)
80105587:	90                   	nop
    lapiceoi();
    break;
...
801055f3:	c7 04 24 04 76 10 80 	movl   $0x80107604,(%esp)
...
801056ba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
801056c0:	e8 0b cf ff ff       	call   801025d0 <kbdintr>
    lapiceoi();
...
8010570e:	66 90                	xchg   %ax,%ax
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105710:	e8 6b c9 ff ff       	call   80102080 <ideintr>
...
80105767:	e8 d4 e9 ff ff       	call   80104140 <acquire>
      ticks++;
      wakeup(&ticks);
...
80105773:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
8010577a:	e8 11 e6 ff ff       	call   80103d90 <wakeup>
      release(&tickslock);
8010577f:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105786:	e8 a5 ea ff ff       	call   80104230 <release>
...
80105796:	e8 e5 de ff ff       	call   80103680 <cpuid>
...
801058b7:	00 
  ...
  for(p="xv6...\n"; *p; p++)
801058b8:	bb c8 76 10 80       	mov    $0x801076c8,%ebx
...
801065e1:	c3                   	ret    
  ...
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
801065e2:	c7 04 24 d0 76 10 80 	movl   $0x801076d0,(%esp)
...
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
801066f1:	c7 04 24 d6 76 10 80 	movl   $0x801076d6,(%esp)
801066f8:	e8 63 9c ff ff       	call   80100360 <panic>
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
801066fd:	c7 04 24 01 77 10 80 	movl   $0x80107701,(%esp)
...
switchuvm(struct proc *p)
{
  ...
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
80106709:	c7 04 24 ec 76 10 80 	movl   $0x801076ec,(%esp)
...
80106798:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80106799:	e9 82 db ff ff       	jmp    80104320 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
8010679e:	c7 04 24 15 77 10 80 	movl   $0x80107715,(%esp)
...
8010682d:	e8 2e b1 ff ff       	call   80101960 <readi>
...
80106851:	c3                   	ret    
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
80106852:	c7 04 24 2f 77 10 80 	movl   $0x8010772f,(%esp)
80106859:	e8 02 9b ff ff       	call   80100360 <panic>
{
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
8010685e:	c7 04 24 d0 77 10 80 	movl   $0x801077d0,(%esp)
...
801068bb:	e8 c0 d9 ff ff       	call   80104280 <memset>
...
801068f5:	76 29                	jbe    80106920 <allocuvm+0xb0>
    mem = kalloc();
801068f7:	e8 a4 bb ff ff       	call   801024a0 <kalloc>
    if(mem == 0){
...
80106900:	75 a6                	jne    801068a8 <allocuvm+0x38>
      cprintf("allocuvm out of memory\n");
80106902:	c7 04 24 4d 77 10 80 	movl   $0x8010774d,(%esp)
...
8010692a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
80106930:	c7 04 24 65 77 10 80 	movl   $0x80107765,(%esp)
...
freevm(pde_t *pgdir)
{
  ...
  if(pgdir == 0)
    panic("freevm: no pgdir");
801069f8:	c7 04 24 81 77 10 80 	movl   $0x80107781,(%esp)
...
80106adb:	c3                   	ret    
{
  ...
  if(pte == 0)
    panic("clearpteu");
80106adc:	c7 04 24 92 77 10 80 	movl   $0x80107792,(%esp)
...
80106af6:	83 ec 2c             	sub    $0x2c,%esp
  ...
  uint pa, i, flags;
  struct proc *curproc = myproc();
80106af9:	e8 a2 cb ff ff       	call   801036a0 <myproc>
...
80106b0b:	0f 84 67 01 00 00    	je     80106c78 <copyuvm+0x188>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106b11:	8b 45 0c             	mov    0xc(%ebp),%eax
80106b14:	85 c0                	test   %eax,%eax
80106b16:	0f 84 ac 00 00 00    	je     80106bc8 <copyuvm+0xd8>
...
80106b20:	81 c7 00 00 00 80    	add    $0x80000000,%edi
80106b26:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106b2d:	00 
80106b2e:	89 7c 24 04          	mov    %edi,0x4(%esp)
80106b32:	89 04 24             	mov    %eax,(%esp)
80106b35:	e8 e6 d7 ff ff       	call   80104320 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106b3a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106b3d:	8d 96 00 00 00 80    	lea    -0x80000000(%esi),%edx
80106b43:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106b47:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106b4e:	00 
80106b4f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106b53:	89 44 24 10          	mov    %eax,0x10(%esp)
...
80106b64:	78 4d                	js     80106bb3 <copyuvm+0xc3>
  struct proc *curproc = myproc();
  char *mem;
...
80106b6f:	76 57                	jbe    80106bc8 <copyuvm+0xd8>
...
80106b7f:	0f 84 06 01 00 00    	je     80106c8b <copyuvm+0x19b>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106b85:	8b 30                	mov    (%eax),%esi
80106b87:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106b8d:	0f 84 ec 00 00 00    	je     80106c7f <copyuvm+0x18f>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106b93:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106b95:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106b9b:	89 75 e4             	mov    %esi,-0x1c(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106b9e:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106ba4:	e8 f7 b8 ff ff       	call   801024a0 <kalloc>
80106ba9:	85 c0                	test   %eax,%eax
80106bab:	89 c6                	mov    %eax,%esi
...
80106bcb:	8b 58 04             	mov    0x4(%eax),%ebx
80106bce:	f7 db                	neg    %ebx
80106bd0:	c1 e3 0c             	shl    $0xc,%ebx
80106bd3:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
80106bd9:	79 53                	jns    80106c2e <copyuvm+0x13e>
80106bdb:	e9 8d 00 00 00       	jmp    80106c6d <copyuvm+0x17d>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
...
80106bf5:	e8 26 d7 ff ff       	call   80104320 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
...
80106c24:	78 8d                	js     80106bb3 <copyuvm+0xc3>
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
      goto bad;
...
80106c2c:	78 3f                	js     80106c6d <copyuvm+0x17d>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106c2e:	8b 45 08             	mov    0x8(%ebp),%eax
80106c31:	31 c9                	xor    %ecx,%ecx
80106c33:	89 da                	mov    %ebx,%edx
80106c35:	e8 46 f7 ff ff       	call   80106380 <walkpgdir>
80106c3a:	85 c0                	test   %eax,%eax
80106c3c:	74 4d                	je     80106c8b <copyuvm+0x19b>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106c3e:	8b 30                	mov    (%eax),%esi
80106c40:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106c46:	74 37                	je     80106c7f <copyuvm+0x18f>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106c48:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106c4a:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106c50:	89 75 e4             	mov    %esi,-0x1c(%ebp)
  for(i = KERNBASE - (curproc->pgcount * PGSIZE); i < KERNBASE; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106c53:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106c59:	e8 42 b8 ff ff       	call   801024a0 <kalloc>
80106c5e:	85 c0                	test   %eax,%eax
80106c60:	89 c6                	mov    %eax,%esi
80106c62:	0f 85 78 ff ff ff    	jne    80106be0 <copyuvm+0xf0>
80106c68:	e9 46 ff ff ff       	jmp    80106bb3 <copyuvm+0xc3>
80106c6d:	8b 45 e0             	mov    -0x20(%ebp),%eax
  return d;
...
80106c7a:	e9 41 ff ff ff       	jmp    80106bc0 <copyuvm+0xd0>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
80106c7f:	c7 04 24 b6 77 10 80 	movl   $0x801077b6,(%esp)
80106c86:	e8 d5 96 ff ff       	call   80100360 <panic>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
80106c8b:	c7 04 24 9c 77 10 80 	movl   $0x8010779c,(%esp)
...
80106d1c:	e8 ff d5 ff ff       	call   80104320 <memmove>
    len -= n;
    buf += n;
...
80106d76:	c7 44 24 04 f4 77 10 	movl   $0x801077f4,0x4(%esp)
80106d7d:	80 
80106d7e:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106d85:	e8 c6 d2 ff ff       	call   80104050 <initlock>
  acquire(&(shm_table.lock));
80106d8a:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106d91:	e8 aa d3 ff ff       	call   80104140 <acquire>
...
80106dc5:	e8 66 d4 ff ff       	call   80104230 <release>
}
80106dca:	c9                   	leave  
80106dcb:	c3                   	ret    
