...
80105283:	e8 08 1c 00 00       	call   80106e90 <shm_close>
}
80105288:	c9                   	leave  
80105289:	c3                   	ret    
...
80106cf9:	8b 7d 08             	mov    0x8(%ebp),%edi
...
80106d1e:	83 fa 3f             	cmp    $0x3f,%edx
80106d21:	74 6d                	je     80106d90 <shm_open+0xa0>
{
  if(shm_table.shm_pages[i].id == id)
80106d23:	3b 39                	cmp    (%ecx),%edi
...
80106d27:	8d 34 52             	lea    (%edx,%edx,2),%esi
80106d2a:	c1 e6 02             	shl    $0x2,%esi
80106d2d:	8b 86 f8 54 11 80    	mov    -0x7feeab08(%esi),%eax
80106d33:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106d3a:	00 
80106d3b:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106d42:	00 
80106d43:	05 00 00 00 80       	add    $0x80000000,%eax
80106d48:	89 44 24 0c          	mov    %eax,0xc(%esp)
80106d4c:	8b 03                	mov    (%ebx),%eax
80106d4e:	89 44 24 04          	mov    %eax,0x4(%esp)
80106d52:	8b 43 04             	mov    0x4(%ebx),%eax
80106d55:	89 04 24             	mov    %eax,(%esp)
80106d58:	e8 f3 f7 ff ff       	call   80106550 <mappages>
80106d5d:	85 c0                	test   %eax,%eax
80106d5f:	0f 88 fd 00 00 00    	js     80106e62 <shm_open+0x172>
    {
      cprintf("Error\n");
      release(&shm_table.lock);
      return -1;
...
80106d65:	83 86 fc 54 11 80 01 	addl   $0x1,-0x7feeab04(%esi)
    *pointer = (char*)curproc->sz;
80106d6c:	8b 03                	mov    (%ebx),%eax
80106d6e:	8b 75 0c             	mov    0xc(%ebp),%esi
80106d71:	89 06                	mov    %eax,(%esi)
    curproc->sz += PGSIZE;
80106d73:	81 03 00 10 00 00    	addl   $0x1000,(%ebx)
    release(&shm_table.lock);
80106d79:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106d80:	e8 bb d4 ff ff       	call   80104240 <release>
    return 0;
...
acquire(&shm_table.lock);
for(i = 0; i < 63; ++i)
80106d90:	31 f6                	xor    %esi,%esi
80106d92:	eb 1c                	jmp    80106db0 <shm_open+0xc0>
80106d94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  release(&shm_table.lock);
80106d98:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
    curproc->sz += PGSIZE;
    release(&shm_table.lock);
    return 0;
  }
...
80106d9f:	83 c6 01             	add    $0x1,%esi
  ...
  release(&shm_table.lock);
80106da2:	e8 99 d4 ff ff       	call   80104240 <release>
    curproc->sz += PGSIZE;
    release(&shm_table.lock);
    return 0;
  }
...
for(i = 0; i < 63; ++i)
80106da7:	83 fe 3f             	cmp    $0x3f,%esi
80106daa:	0f 84 ab 00 00 00    	je     80106e5b <shm_open+0x16b>
80106db0:	8d 04 76             	lea    (%esi,%esi,2),%eax
80106db3:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
{
  if(shm_table.shm_pages[i].id == 0)
80106dba:	8b 04 85 f4 54 11 80 	mov    -0x7feeab0c(,%eax,4),%eax
80106dc1:	85 c0                	test   %eax,%eax
80106dc3:	75 d3                	jne    80106d98 <shm_open+0xa8>
  {
    shm_table.shm_pages[i].id = id;
80106dc5:	89 ba f4 54 11 80    	mov    %edi,-0x7feeab0c(%edx)
80106dcb:	89 55 e4             	mov    %edx,-0x1c(%ebp)
    shm_table.shm_pages[i].frame = kalloc();
80106dce:	e8 dd b6 ff ff       	call   801024b0 <kalloc>
80106dd3:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    memset(shm_table.shm_pages[i].frame,0, PGSIZE);
80106dd6:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106ddd:	00 
...
for(i = 0; i < 63; ++i)
{
  if(shm_table.shm_pages[i].id == 0)
  {
    shm_table.shm_pages[i].id = id;
    shm_table.shm_pages[i].frame = kalloc();
80106de6:	8d b2 c8 54 11 80    	lea    -0x7feeab38(%edx),%esi
    memset(shm_table.shm_pages[i].frame,0, PGSIZE);
...
for(i = 0; i < 63; ++i)
{
  if(shm_table.shm_pages[i].id == 0)
  {
    shm_table.shm_pages[i].id = id;
    shm_table.shm_pages[i].frame = kalloc();
80106def:	89 82 f8 54 11 80    	mov    %eax,-0x7feeab08(%edx)
    memset(shm_table.shm_pages[i].frame,0, PGSIZE);
80106df5:	e8 96 d4 ff ff       	call   80104290 <memset>
    shm_table.shm_pages[i].refcnt = 1;
80106dfa:	8b 55 e4             	mov    -0x1c(%ebp),%edx

    if(mappages(curproc->pgdir, (char*)curproc->sz, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U) < 0)
80106dfd:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106e04:	00 
  if(shm_table.shm_pages[i].id == 0)
  {
    shm_table.shm_pages[i].id = id;
    ...
    memset(shm_table.shm_pages[i].frame,0, PGSIZE);
    shm_table.shm_pages[i].refcnt = 1;
80106e05:	c7 82 fc 54 11 80 01 	movl   $0x1,-0x7feeab04(%edx)
80106e0c:	00 00 00 

    if(mappages(curproc->pgdir, (char*)curproc->sz, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U) < 0)
80106e0f:	8b 46 30             	mov    0x30(%esi),%eax
80106e12:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106e19:	00 
80106e1a:	05 00 00 00 80       	add    $0x80000000,%eax
80106e1f:	89 44 24 0c          	mov    %eax,0xc(%esp)
80106e23:	8b 03                	mov    (%ebx),%eax
80106e25:	89 44 24 04          	mov    %eax,0x4(%esp)
80106e29:	8b 43 04             	mov    0x4(%ebx),%eax
80106e2c:	89 04 24             	mov    %eax,(%esp)
80106e2f:	e8 1c f7 ff ff       	call   80106550 <mappages>
80106e34:	85 c0                	test   %eax,%eax
80106e36:	78 2a                	js     80106e62 <shm_open+0x172>
    {
      cprintf("Error\n");
      release(&shm_table.lock);
      return -1;
    ...
    *pointer = (char*)curproc->sz;
80106e38:	8b 03                	mov    (%ebx),%eax
80106e3a:	8b 7d 0c             	mov    0xc(%ebp),%edi
80106e3d:	89 07                	mov    %eax,(%edi)
    curproc->sz += PGSIZE;
80106e3f:	81 03 00 10 00 00    	addl   $0x1000,(%ebx)
    release(&shm_table.lock);
...
80106e51:	83 c4 2c             	add    $0x2c,%esp
      return -1;
    }
    *pointer = (char*)curproc->sz;
    curproc->sz += PGSIZE;
...
80106e5d:	e9 25 ff ff ff       	jmp    80106d87 <shm_open+0x97>
{
  if(shm_table.shm_pages[i].id == id)
  {
    if(mappages(curproc->pgdir, (char*)curproc->sz, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U) < 0)
    {
      cprintf("Error\n");
80106e62:	c7 04 24 1d 79 10 80 	movl   $0x8010791d,(%esp)
80106e69:	e8 e2 97 ff ff       	call   80100650 <cprintf>
      release(&shm_table.lock);
80106e6e:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106e75:	e8 c6 d3 ff ff       	call   80104240 <release>
      return -1;
80106e7a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106e7f:	e9 03 ff ff ff       	jmp    80106d87 <shm_open+0x97>
...
80106e95:	bb f4 54 11 80       	mov    $0x801154f4,%ebx
...
acquire(&shm_table.lock);
80106ea0:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106ea7:	e8 a4 d2 ff ff       	call   80104150 <acquire>
80106eac:	eb 0d                	jmp    80106ebb <shm_close+0x2b>
80106eae:	66 90                	xchg   %ax,%ax
80106eb0:	83 c3 0c             	add    $0xc,%ebx
for(i = 0; i < 63; ++i)
80106eb3:	81 fb e8 57 11 80    	cmp    $0x801157e8,%ebx
80106eb9:	74 29                	je     80106ee4 <shm_close+0x54>
{
  if(shm_table.shm_pages[i].id == id)
80106ebb:	3b 33                	cmp    (%ebx),%esi
80106ebd:	75 f1                	jne    80106eb0 <shm_close+0x20>
  {
    if(shm_table.shm_pages[i].refcnt - 1 == 0)
80106ebf:	8b 43 08             	mov    0x8(%ebx),%eax
80106ec2:	83 f8 01             	cmp    $0x1,%eax
80106ec5:	74 29                	je     80106ef0 <shm_close+0x60>
      shm_table.shm_pages[i].refcnt = 0;
      release(&shm_table.lock);
    }
    else
    {
      shm_table.shm_pages[i].refcnt -= 1;
80106ec7:	83 e8 01             	sub    $0x1,%eax
80106eca:	83 c3 0c             	add    $0xc,%ebx
80106ecd:	89 43 fc             	mov    %eax,-0x4(%ebx)
      release(&shm_table.lock);
80106ed0:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106ed7:	e8 64 d3 ff ff       	call   80104240 <release>
int shm_close(int id) {
...
acquire(&shm_table.lock);
for(i = 0; i < 63; ++i)
80106edc:	81 fb e8 57 11 80    	cmp    $0x801157e8,%ebx
80106ee2:	75 d7                	jne    80106ebb <shm_close+0x2b>
    }
  }
}
...
80106eed:	8d 76 00             	lea    0x0(%esi),%esi
    if(shm_table.shm_pages[i].refcnt - 1 == 0)
    {
      ...
      shm_table.shm_pages[i].refcnt = 0;
      release(&shm_table.lock);
80106ef0:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
{
  if(shm_table.shm_pages[i].id == id)
  {
    if(shm_table.shm_pages[i].refcnt - 1 == 0)
    {
      shm_table.shm_pages[i].id = 0;
80106ef7:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
      shm_table.shm_pages[i].frame = 0;
80106efd:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
      shm_table.shm_pages[i].refcnt = 0;
80106f04:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
      release(&shm_table.lock);
80106f0b:	e8 30 d3 ff ff       	call   80104240 <release>
80106f10:	eb 9e                	jmp    80106eb0 <shm_close+0x20>
