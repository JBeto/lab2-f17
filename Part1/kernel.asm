...
8010037e:	c7 04 24 2d 71 10 80 	movl   $0x8010712d,(%esp)
...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 d7 7a 10 80 	movl   $0x80107ad7,(%esp)
...
801003bd:	c7 04 24 41 71 10 80 	movl   $0x80107141,(%esp)
...
80100409:	e8 c2 54 00 00       	call   801058d0 <uartputc>
}
...
801004b9:	e8 12 54 00 00       	call   801058d0 <uartputc>
801004be:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801004c5:	e8 06 54 00 00       	call   801058d0 <uartputc>
801004ca:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
801004d1:	e8 fa 53 00 00       	call   801058d0 <uartputc>
...
80100525:	e9 59 ff ff ff       	jmp    80100483 <consputc+0xa3>
  ...
  if(pos < 0 || pos > 25*80)
    panic("pos under/overflow");
8010052a:	c7 04 24 45 71 10 80 	movl   $0x80107145,(%esp)
...
80100599:	0f b6 92 70 71 10 80 	movzbl -0x7fef8e90(%edx),%edx
  }while((x /= base) != 0);
...
8010075d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        s = "(null)";
80100760:	b8 58 71 10 80       	mov    $0x80107158,%eax
...
8010079c:	e9 c8 fe ff ff       	jmp    80100669 <cprintf+0x19>
  ...
  if (fmt == 0)
    panic("null fmt");
801007a1:	c7 04 24 5f 71 10 80 	movl   $0x8010715f,(%esp)
...
80100956:	c7 44 24 04 68 71 10 	movl   $0x80107168,0x4(%esp)
8010095d:	80 
...
80100b5e:	e8 dd 5d 00 00       	call   80106940 <allocuvm>
...
80100b70:	e8 eb 5e 00 00       	call   80106a60 <freevm>
  if(ip){
    iunlockput(ip);
    end_op();
  }
...
80100b7f:	e8 0c 20 00 00       	call   80102b90 <end_op>
    cprintf("exec: fail\n");
80100b84:	c7 04 24 81 71 10 80 	movl   $0x80107181,(%esp)
...
80100bab:	e8 e0 5f 00 00       	call   80106b90 <clearpteu>
  curproc->pgcount = 1;
80100bb0:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
80100bb6:	c7 40 04 01 00 00 00 	movl   $0x1,0x4(%eax)
  sp = USERSTACK;
...
80100bc4:	0f 84 6f 01 00 00    	je     80100d39 <exec+0x399>
80100bca:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80100bcd:	31 d2                	xor    %edx,%edx
  uint stack = KERNBASE - (2 * PGSIZE);
  if(allocuvm(pgdir, stack, USERSTACK) == 0)
    goto bad;
  clearpteu(pgdir, (char*)stack);
  curproc->pgcount = 1;
  sp = USERSTACK;
80100bcf:	bb fc ff ff 7f       	mov    $0x7ffffffc,%ebx
80100bd4:	8d 71 04             	lea    0x4(%ecx),%esi

  // Push argument strings, prepare rest of stack in ustack.
  for(argc = 0; argv[argc]; argc++) {
80100bd7:	89 cf                	mov    %ecx,%edi
80100bd9:	89 d1                	mov    %edx,%ecx
80100bdb:	89 f2                	mov    %esi,%edx
80100bdd:	89 fe                	mov    %edi,%esi
80100bdf:	89 cf                	mov    %ecx,%edi
80100be1:	eb 11                	jmp    80100bf4 <exec+0x254>
80100be3:	90                   	nop
...
80100c2d:	e8 ae 61 00 00       	call   80106de0 <copyout>
...
80100c9a:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  ...
  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100ca0:	e8 3b 61 00 00       	call   80106de0 <copyout>
...
80100ce7:	83 c0 70             	add    $0x70,%eax
...
80100cf8:	8b 95 f0 fe ff ff    	mov    -0x110(%ebp),%edx
  ...
  // Commit to the user image.
  oldpgdir = curproc->pgdir;
80100cfe:	8b 77 08             	mov    0x8(%edi),%esi
  end_op();
  ip = 0;
...
80100d0d:	8b 47 1c             	mov    0x1c(%edi),%eax
      last = s+1;
  safestrcpy(curproc->name, last, sizeof(curproc->name));
...
80100d34:	e9 d9 fc ff ff       	jmp    80100a12 <exec+0x72>
  ...
  curproc->pgcount = 1;
  sp = USERSTACK;
80100d39:	bb fc ff ff 7f       	mov    $0x7ffffffc,%ebx
...
80100d56:	c7 44 24 04 8d 71 10 	movl   $0x8010718d,0x4(%esp)
80100d5d:	80 
...
filedup(struct file *f)
{
  ...
  if(f->ref < 1)
    panic("filedup");
80100e17:	c7 04 24 94 71 10 80 	movl   $0x80107194,(%esp)
...
80100ed7:	e9 b4 1c 00 00       	jmp    80102b90 <end_op>
{
  ...
  if(f->ref < 1)
    panic("fileclose");
80100edc:	c7 04 24 9c 71 10 80 	movl   $0x8010719c,(%esp)
...
80100fc5:	eb d8                	jmp    80100f9f <fileread+0x5f>
  ...
  panic("fileread");
80100fc7:	c7 04 24 a6 71 10 80 	movl   $0x801071a6,(%esp)
...
801010dc:	e9 1f 22 00 00       	jmp    80103300 <pipewrite>
      ...
      if(r != n1)
        panic("short filewrite");
801010e1:	c7 04 24 af 71 10 80 	movl   $0x801071af,(%esp)
801010e8:	e8 73 f2 ff ff       	call   80100360 <panic>
  ...
  panic("filewrite");
801010ed:	c7 04 24 b5 71 10 80 	movl   $0x801071b5,(%esp)
...
801011a5:	c7 04 24 bf 71 10 80 	movl   $0x801071bf,(%esp)
...
801012cc:	c3                   	ret    
  ...
  if(empty == 0)
    panic("iget: no inodes");
801012cd:	c7 04 24 d5 71 10 80 	movl   $0x801071d5,(%esp)
...
80101385:	eb 93                	jmp    8010131a <bmap+0x3a>
  ...
  panic("bmap: out of range");
80101387:	c7 04 24 e5 71 10 80 	movl   $0x801071e5,(%esp)
...
80101468:	c3                   	ret    
  ...
  if((bp->data[bi/8] & m) == 0)
    panic("freeing free block");
80101469:	c7 04 24 f8 71 10 80 	movl   $0x801071f8,(%esp)
...
8010148c:	c7 44 24 04 0b 72 10 	movl   $0x8010720b,0x4(%esp)
80101493:	80 
...
801014a9:	c7 44 24 04 12 72 10 	movl   $0x80107212,0x4(%esp)
801014b0:	80 
...
801014d6:	c7 04 24 78 72 10 80 	movl   $0x80107278,(%esp)
...
801015ec:	e9 2f fc ff ff       	jmp    80101220 <iget>
  ...
  panic("ialloc: no inodes");
801015f1:	c7 04 24 18 72 10 80 	movl   $0x80107218,(%esp)
...
80101774:	0f 85 76 ff ff ff    	jne    801016f0 <ilock+0x30>
      panic("ilock: no type");
8010177a:	c7 04 24 30 72 10 80 	movl   $0x80107230,(%esp)
80101781:	e8 da eb ff ff       	call   80100360 <panic>
{
  ...
  if(ip == 0 || ip->ref < 1)
    panic("ilock");
80101786:	c7 04 24 2a 72 10 80 	movl   $0x8010722a,(%esp)
...
iunlock(struct inode *ip)
{
  if(ip == 0 || !holdingsleep(&ip->lock) || ip->ref < 1)
    panic("iunlock");
801017d3:	c7 04 24 3f 72 10 80 	movl   $0x8010723f,(%esp)
...
80101c71:	c3                   	ret    
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlookup read");
80101c72:	c7 04 24 59 72 10 80 	movl   $0x80107259,(%esp)
80101c79:	e8 e2 e6 ff ff       	call   80100360 <panic>
{
  ...
  if(dp->type != T_DIR)
    panic("dirlookup not DIR");
80101c7e:	c7 04 24 47 72 10 80 	movl   $0x80107247,(%esp)
...
80101ef3:	eb e9                	jmp    80101ede <dirlink+0xae>
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlink read");
80101ef5:	c7 04 24 68 72 10 80 	movl   $0x80107268,(%esp)
80101efc:	e8 5f e4 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("dirlink");
80101f01:	c7 04 24 66 78 10 80 	movl   $0x80107866,(%esp)
...
80101fef:	c7 04 24 d4 72 10 80 	movl   $0x801072d4,(%esp)
...
idestart(struct buf *b)
{
  if(b == 0)
    panic("idestart");
80101ffb:	c7 04 24 cb 72 10 80 	movl   $0x801072cb,(%esp)
...
80102016:	c7 44 24 04 e6 72 10 	movl   $0x801072e6,0x4(%esp)
8010201d:	80 
...
iderw(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    panic("iderw: buf not locked");
801021eb:	c7 04 24 ea 72 10 80 	movl   $0x801072ea,(%esp)
801021f2:	e8 69 e1 ff ff       	call   80100360 <panic>
  if((b->flags & (B_VALID|B_DIRTY)) == B_VALID)
    panic("iderw: nothing to do");
  if(b->dev != 0 && !havedisk1)
    panic("iderw: ide disk 1 not present");
801021f7:	c7 04 24 15 73 10 80 	movl   $0x80107315,(%esp)
801021fe:	e8 5d e1 ff ff       	call   80100360 <panic>
  ...
  if((b->flags & (B_VALID|B_DIRTY)) == B_VALID)
    panic("iderw: nothing to do");
80102203:	c7 04 24 00 73 10 80 	movl   $0x80107300,(%esp)
...
80102258:	c7 04 24 34 73 10 80 	movl   $0x80107334,(%esp)
...
kfree(char *v)
{
  ...
  if((uint)v % PGSIZE || v < end || V2P(v) >= PHYSTOP)
    panic("kfree");
8010238e:	c7 04 24 66 73 10 80 	movl   $0x80107366,(%esp)
...
801023fb:	c7 44 24 04 6c 73 10 	movl   $0x8010736c,0x4(%esp)
80102402:	80 
...
80102544:	0f b6 81 a0 74 10 80 	movzbl -0x7fef8b60(%ecx),%eax
...
80102578:	0f b6 91 a0 74 10 80 	movzbl -0x7fef8b60(%ecx),%edx
  shift ^= togglecode[data];
8010257f:	0f b6 81 a0 73 10 80 	movzbl -0x7fef8c60(%ecx),%eax
    // Last character was an E0 escape; or with 0x80
    data |= 0x80;
    shift &= ~E0ESC;
  }
...
8010258f:	8b 04 85 80 73 10 80 	mov    -0x7fef8c80(,%eax,4),%eax
    data |= 0x80;
    shift &= ~E0ESC;
  }
...
80102a8b:	c7 44 24 04 a0 75 10 	movl   $0x801075a0,0x4(%esp)
80102a92:	80 
...
80102cb2:	c3                   	ret    
  ...
  if(log.committing)
    panic("log.committing");
80102cb3:	c7 04 24 a4 75 10 80 	movl   $0x801075a4,(%esp)
...
log_write(struct buf *b)
{
  ...
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
    panic("too big a transaction");
80102d70:	c7 04 24 b3 75 10 80 	movl   $0x801075b3,(%esp)
80102d77:	e8 e4 d5 ff ff       	call   80100360 <panic>
  if (log.outstanding < 1)
    panic("log_write outside of trans");
80102d7c:	c7 04 24 c9 75 10 80 	movl   $0x801075c9,(%esp)
...
80102da7:	c7 04 24 e4 75 10 80 	movl   $0x801075e4,(%esp)
...
80102de3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102de6:	e8 d5 38 00 00       	call   801066c0 <switchkvm>
  seginit();
80102deb:	e8 90 37 00 00       	call   80106580 <seginit>
  lapicinit();
...
80102e35:	e8 46 37 00 00       	call   80106580 <seginit>
  picinit();       // disable pic
...
80102e4a:	e8 d1 2a 00 00       	call   80105920 <uartinit>
80102e4f:	90                   	nop
  pinit();         // process table
80102e50:	e8 9b 07 00 00       	call   801035f0 <pinit>
  shminit();       // shared memory
80102e55:	e8 16 40 00 00       	call   80106e70 <shminit>
  tvinit();        // trap vectors
...
80102f4f:	00 
80102f50:	c7 44 24 04 f8 75 10 	movl   $0x801075f8,0x4(%esp)
80102f57:	80 
...
8010300a:	00 
8010300b:	c7 44 24 04 fd 75 10 	movl   $0x801075fd,0x4(%esp)
80103012:	80 
...
8010309c:	ff 24 8d 3c 76 10 80 	jmp    *-0x7fef89c4(,%ecx,4)
801030a3:	90                   	nop
...
80103127:	0f 85 c5 fe ff ff    	jne    80102ff2 <mpinit+0x52>
  ...
  if((conf = mpconfig(&mp)) == 0)
    panic("Expect to run on an SMP");
8010312d:	c7 04 24 02 76 10 80 	movl   $0x80107602,(%esp)
...
80103148:	eb e3                	jmp    8010312d <mpinit+0x18d>
  ...
  if(!ismp)
    panic("Didn't find a suitable machine");
8010314a:	c7 04 24 1c 76 10 80 	movl   $0x8010761c,(%esp)
...
801031ef:	c7 44 24 04 50 76 10 	movl   $0x80107650,0x4(%esp)
801031f6:	80 
...
801034e8:	eb 15                	jmp    801034ff <allocproc+0x2f>
...
801034f9:	0f 84 81 00 00 00    	je     80103580 <allocproc+0xb0>
    if(p->state == UNUSED)
801034ff:	8b 43 10             	mov    0x10(%ebx),%eax
80103502:	85 c0                	test   %eax,%eax
80103504:	75 ea                	jne    801034f0 <allocproc+0x20>
  release(&ptable.lock);
  return 0;
...
found:
  p->state = EMBRYO;
  p->pid = nextpid++;
80103506:	a1 04 a0 10 80       	mov    0x8010a004,%eax
  p->pgcount = 1; 
  release(&ptable.lock);
8010350b:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
...
found:
  p->state = EMBRYO;
80103512:	c7 43 10 01 00 00 00 	movl   $0x1,0x10(%ebx)
  p->pid = nextpid++;
  p->pgcount = 1; 
80103519:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
  release(&ptable.lock);
  return 0;
...
found:
  p->state = EMBRYO;
  p->pid = nextpid++;
80103520:	8d 50 01             	lea    0x1(%eax),%edx
80103523:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
80103529:	89 43 14             	mov    %eax,0x14(%ebx)
  p->pgcount = 1; 
  release(&ptable.lock);
8010352c:	e8 0f 0d 00 00       	call   80104240 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
80103531:	e8 7a ef ff ff       	call   801024b0 <kalloc>
80103536:	85 c0                	test   %eax,%eax
80103538:	89 43 0c             	mov    %eax,0xc(%ebx)
8010353b:	74 57                	je     80103594 <allocproc+0xc4>
    return 0;
  }
  ...
  sp -= sizeof *p->tf;
8010353d:	8d 90 b4 0f 00 00    	lea    0xfb4(%eax),%edx
  ...
  *(uint*)sp = (uint)trapret;
  ...
  sp -= sizeof *p->context;
80103543:	05 9c 0f 00 00       	add    $0xf9c,%eax
    return 0;
  }
  sp = p->kstack + KSTACKSIZE;
  ...
  // Leave room for trap frame.
  sp -= sizeof *p->tf;
80103548:	89 53 1c             	mov    %edx,0x1c(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
8010354b:	c7 40 14 45 54 10 80 	movl   $0x80105445,0x14(%eax)

  sp -= sizeof *p->context;
  p->context = (struct context*)sp;
  memset(p->context, 0, sizeof *p->context);
80103552:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80103559:	00 
...
80103562:	89 04 24             	mov    %eax,(%esp)
  ...
  *(uint*)sp = (uint)trapret;
  ...
  sp -= sizeof *p->context;
  p->context = (struct context*)sp;
80103565:	89 43 20             	mov    %eax,0x20(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103568:	e8 23 0d 00 00       	call   80104290 <memset>
  p->context->eip = (uint)forkret;
8010356d:	8b 43 20             	mov    0x20(%ebx),%eax
80103570:	c7 40 10 a0 35 10 80 	movl   $0x801035a0,0x10(%eax)

  return p;
80103577:	89 d8                	mov    %ebx,%eax
}
80103579:	83 c4 14             	add    $0x14,%esp
8010357c:	5b                   	pop    %ebx
8010357d:	5d                   	pop    %ebp
8010357e:	c3                   	ret    
8010357f:	90                   	nop
...
80103587:	e8 b4 0c 00 00       	call   80104240 <release>
  p->context = (struct context*)sp;
  memset(p->context, 0, sizeof *p->context);
  p->context->eip = (uint)forkret;
...
8010358c:	83 c4 14             	add    $0x14,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
    if(p->state == UNUSED)
      goto found;
...
80103593:	c3                   	ret    
  ...
  if((p->kstack = kalloc()) == 0){
    p->state = UNUSED;
80103594:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
    return 0;
8010359b:	eb dc                	jmp    80103579 <allocproc+0xa9>
...
801035f6:	c7 44 24 04 55 76 10 	movl   $0x80107655,0x4(%esp)
801035fd:	80 
...
80103668:	eb ea                	jmp    80103654 <mycpu+0x44>
  ...
  panic("unknown apicid\n");
8010366a:	c7 04 24 5c 76 10 80 	movl   $0x8010765c,(%esp)
...
mycpu(void)
{
  ...
  if(readeflags()&FL_IF)
    panic("mycpu called with interrupts enabled\n");
80103676:	c7 04 24 38 77 10 80 	movl   $0x80107738,(%esp)
...
801036fa:	89 43 08             	mov    %eax,0x8(%ebx)
...
80103715:	80 
80103716:	e8 d5 30 00 00       	call   801067f0 <inituvm>
  p->sz = PGSIZE;
...
80103792:	00 
80103793:	c7 44 24 04 85 76 10 	movl   $0x80107685,0x4(%esp)
8010379a:	80 
8010379b:	89 04 24             	mov    %eax,(%esp)
8010379e:	e8 cd 0c 00 00       	call   80104470 <safestrcpy>
  p->cwd = namei("/");
801037a3:	c7 04 24 8e 76 10 80 	movl   $0x8010768e,(%esp)
...
801037d6:	c3                   	ret    
  ...
  if((p->pgdir = setupkvm()) == 0)
    panic("userinit: out of memory?");
801037d7:	c7 04 24 6c 76 10 80 	movl   $0x8010766c,(%esp)
...
80103813:	8b 43 08             	mov    0x8(%ebx),%eax
80103816:	89 04 24             	mov    %eax,(%esp)
80103819:	e8 22 31 00 00       	call   80106940 <allocuvm>
...
80103827:	e8 b4 2e 00 00       	call   801066e0 <switchuvm>
  return 0;
...
80103894:	e8 57 33 00 00       	call   80106bf0 <copyuvm>
80103899:	85 c0                	test   %eax,%eax
8010389b:	89 47 08             	mov    %eax,0x8(%edi)
8010389e:	0f 84 a9 00 00 00    	je     8010394d <fork+0xed>
    kfree(np->kstack);
    np->kstack = 0;
    np->state = UNUSED;
    return -1;
...
801038a6:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
801038a9:	89 01                	mov    %eax,(%ecx)
  np->parent = curproc;
  *np->tf = *curproc->tf;
801038ab:	8b 79 1c             	mov    0x1c(%ecx),%edi
801038ae:	89 c8                	mov    %ecx,%eax
    np->kstack = 0;
    np->state = UNUSED;
    return -1;
  }
  np->sz = curproc->sz;
  np->parent = curproc;
801038b0:	89 59 18             	mov    %ebx,0x18(%ecx)
  *np->tf = *curproc->tf;
801038b3:	8b 73 1c             	mov    0x1c(%ebx),%esi
801038b6:	b9 13 00 00 00       	mov    $0x13,%ecx
801038bb:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

  // Clear %eax so that fork returns 0 in the child.
  np->tf->eax = 0;

  for(i = 0; i < NOFILE; i++)
801038bd:	31 f6                	xor    %esi,%esi
  np->sz = curproc->sz;
  np->parent = curproc;
  *np->tf = *curproc->tf;
  ...
  // Clear %eax so that fork returns 0 in the child.
  np->tf->eax = 0;
801038bf:	8b 40 1c             	mov    0x1c(%eax),%eax
801038c2:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
...
80103950:	8b 47 0c             	mov    0xc(%edi),%eax
...
8010395b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  ...
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz)) == 0){
    kfree(np->kstack);
    np->kstack = 0;
80103960:	c7 47 0c 00 00 00 00 	movl   $0x0,0xc(%edi)
    np->state = UNUSED;
...
801039c2:	83 eb 80             	sub    $0xffffff80,%ebx
      ...
      c->proc = p;
      switchuvm(p);
801039c5:	e8 16 2d 00 00       	call   801066e0 <switchuvm>
      p->state = RUNNING;
...
801039db:	e8 eb 0a 00 00       	call   801044cb <swtch>
      switchkvm();
801039e0:	e8 db 2c 00 00       	call   801066c0 <switchkvm>
    // Enable interrupts on this processor.
    sti();
...
80103a7d:	c3                   	ret    
{
  ...
  if(!holding(&ptable.lock))
    panic("sched ptable.lock");
80103a7e:	c7 04 24 90 76 10 80 	movl   $0x80107690,(%esp)
80103a85:	e8 d6 c8 ff ff       	call   80100360 <panic>
  ...
  if(readeflags()&FL_IF)
    panic("sched interruptible");
80103a8a:	c7 04 24 bc 76 10 80 	movl   $0x801076bc,(%esp)
80103a91:	e8 ca c8 ff ff       	call   80100360 <panic>
  ...
  if(p->state == RUNNING)
    panic("sched running");
80103a96:	c7 04 24 ae 76 10 80 	movl   $0x801076ae,(%esp)
80103a9d:	e8 be c8 ff ff       	call   80100360 <panic>
  ...
  if(mycpu()->ncli != 1)
    panic("sched locks");
80103aa2:	c7 04 24 a2 76 10 80 	movl   $0x801076a2,(%esp)
...
80103ba6:	e8 65 fe ff ff       	call   80103a10 <sched>
  panic("zombie exit");
80103bab:	c7 04 24 dd 76 10 80 	movl   $0x801076dd,(%esp)
80103bb2:	e8 a9 c7 ff ff       	call   80100360 <panic>
  ...
  if(curproc == initproc)
    panic("init exiting");
80103bb7:	c7 04 24 d0 76 10 80 	movl   $0x801076d0,(%esp)
...
80103c9e:	c7 04 24 ef 76 10 80 	movl   $0x801076ef,(%esp)
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  if(p == 0)
    panic("sleep");
80103caa:	c7 04 24 e9 76 10 80 	movl   $0x801076e9,(%esp)
...
80103d48:	e8 13 2d 00 00       	call   80106a60 <freevm>
        p->pid = 0;
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
...
80103e94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e98:	c7 04 24 d7 7a 10 80 	movl   $0x80107ad7,(%esp)
...
80103eba:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
80103ebd:	ba 00 77 10 80       	mov    $0x80107700,%edx
  uint pc[10];
...
80103ec4:	8b 14 85 60 77 10 80 	mov    -0x7fef88a0(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
80103ecb:	b8 00 77 10 80       	mov    $0x80107700,%eax
...
80103ee0:	c7 04 24 04 77 10 80 	movl   $0x80107704,(%esp)
...
80103f29:	c7 04 24 41 71 10 80 	movl   $0x80107141,(%esp)
...
80103f5a:	c7 44 24 04 78 77 10 	movl   $0x80107778,0x4(%esp)
80103f61:	80 
...
801041b7:	eb ac                	jmp    80104165 <acquire+0x15>
    panic("acquire");
801041b9:	c7 04 24 83 77 10 80 	movl   $0x80107783,(%esp)
...
popcli(void)
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
8010421a:	c7 04 24 a2 77 10 80 	movl   $0x801077a2,(%esp)
...
popcli(void)
{
  if(readeflags()&FL_IF)
    panic("popcli - interruptible");
80104226:	c7 04 24 8b 77 10 80 	movl   $0x8010778b,(%esp)
...
release(struct spinlock *lk)
{
  if(!holding(lk))
    panic("release");
80104251:	c7 04 24 a9 77 10 80 	movl   $0x801077a9,(%esp)
...
801044e6:	3d fc ff ff 7f       	cmp    $0x7ffffffc,%eax
...
80104508:	78 25                	js     8010452f <fetchstr+0x2f>
    return -1;
  *pp = (char*)addr;
8010450a:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  ep = (char*)KERNBASE;
  for(s = *pp; s < ep; s++) {
8010450d:	81 fa ff ff ff 7f    	cmp    $0x7fffffff,%edx
fetchstr(uint addr, char **pp)
{
  char *s, *ep;
  if(addr >= KERNBASE)
...
80104515:	89 11                	mov    %edx,(%ecx)
  ep = (char*)KERNBASE;
  for(s = *pp; s < ep; s++) {
80104517:	77 16                	ja     8010452f <fetchstr+0x2f>
    if(*s == 0)
80104519:	80 3a 00             	cmpb   $0x0,(%edx)
8010451c:	75 07                	jne    80104525 <fetchstr+0x25>
8010451e:	eb 18                	jmp    80104538 <fetchstr+0x38>
...
801045ea:	78 2e                	js     8010461a <argstr+0x4a>
    return -1;
...
801045f1:	78 27                	js     8010461a <argstr+0x4a>
    return -1;
  *pp = (char*)addr;
801045f3:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  ep = (char*)KERNBASE;
  for(s = *pp; s < ep; s++) {
801045f6:	81 fa ff ff ff 7f    	cmp    $0x7fffffff,%edx
fetchstr(uint addr, char **pp)
{
  char *s, *ep;
  if(addr >= KERNBASE)
    return -1;
  *pp = (char*)addr;
801045fc:	89 d0                	mov    %edx,%eax
801045fe:	89 11                	mov    %edx,(%ecx)
  ep = (char*)KERNBASE;
  for(s = *pp; s < ep; s++) {
80104600:	77 18                	ja     8010461a <argstr+0x4a>
    if(*s == 0)
80104602:	80 3a 00             	cmpb   $0x0,(%edx)
80104605:	75 0e                	jne    80104615 <argstr+0x45>
80104607:	eb 1f                	jmp    80104628 <argstr+0x58>
80104609:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104610:	80 38 00             	cmpb   $0x0,(%eax)
80104613:	74 13                	je     80104628 <argstr+0x58>
  char *s, *ep;
  if(addr >= KERNBASE)
    return -1;
  *pp = (char*)addr;
...
80104618:	79 f6                	jns    80104610 <argstr+0x40>
int
argstr(int n, char **pp)
{
  int addr;
...
8010464d:	8b 14 85 e0 77 10 80 	mov    -0x7fef8820(,%eax,4),%edx
...
80104676:	c7 04 24 b1 77 10 80 	movl   $0x801077b1,(%esp)
...
80104800:	c7 44 24 04 5c 78 10 	movl   $0x8010785c,0x4(%esp)
80104807:	80 
...
8010481b:	c7 44 24 04 5b 78 10 	movl   $0x8010785b,0x4(%esp)
80104822:	80 
...
80104831:	79 89                	jns    801047bc <create+0xdc>
      panic("create dots");
80104833:	c7 04 24 4f 78 10 80 	movl   $0x8010784f,(%esp)
8010483a:	e8 21 bb ff ff       	call   80100360 <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
    panic("create: dirlink");
8010483f:	c7 04 24 5e 78 10 80 	movl   $0x8010785e,(%esp)
80104846:	e8 15 bb ff ff       	call   80100360 <panic>
  ...
  if((ip = ialloc(dp->dev, type)) == 0)
    panic("create: ialloc");
8010484b:	c7 04 24 40 78 10 80 	movl   $0x80107840,(%esp)
...
80104bf1:	c7 44 24 04 5c 78 10 	movl   $0x8010785c,0x4(%esp)
80104bf8:	80 
...
80104c09:	c7 44 24 04 5b 78 10 	movl   $0x8010785b,0x4(%esp)
80104c10:	80 
...
80104d58:	e9 48 ff ff ff       	jmp    80104ca5 <sys_unlink+0x105>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
80104d5d:	c7 04 24 80 78 10 80 	movl   $0x80107880,(%esp)
80104d64:	e8 f7 b5 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("unlink: writei");
80104d69:	c7 04 24 92 78 10 80 	movl   $0x80107892,(%esp)
80104d70:	e8 eb b5 ff ff       	call   80100360 <panic>
  ...
  if(ip->nlink < 1)
    panic("unlink: nlink < 1");
80104d75:	c7 04 24 6e 78 10 80 	movl   $0x8010786e,(%esp)
...
80105229:	e8 a2 1c 00 00       	call   80106ed0 <shm_open>
}
8010522e:	c9                   	leave  
8010522f:	c3                   	ret    
int sys_shm_open(void) {
...
80105263:	e8 08 1e 00 00       	call   80107070 <shm_close>
}
80105268:	c9                   	leave  
80105269:	c3                   	ret    
...
801054a9:	c7 44 24 04 a1 78 10 	movl   $0x801078a1,0x4(%esp)
801054b0:	80 
...
80105532:	0f 84 88 02 00 00    	je     801057c0 <trap+0x2a0>
    if(myproc()->killed)
      exit();
    return;
  }
...
8010553e:	0f 87 4c 01 00 00    	ja     80105690 <trap+0x170>
80105544:	ff 24 85 58 79 10 80 	jmp    *-0x7fef86a8(,%eax,4)
8010554b:	90                   	nop
...
80105553:	e8 58 e1 ff ff       	call   801036b0 <myproc>
80105558:	8b 40 04             	mov    0x4(%eax),%eax
8010555b:	f7 d8                	neg    %eax
8010555d:	c1 e0 0c             	shl    $0xc,%eax
80105560:	05 00 00 00 80       	add    $0x80000000,%eax
80105565:	39 f0                	cmp    %esi,%eax
80105567:	0f 86 23 01 00 00    	jbe    80105690 <trap+0x170>
8010556d:	0f 20 d6             	mov    %cr2,%esi
80105570:	e8 3b e1 ff ff       	call   801036b0 <myproc>
80105575:	8b 40 04             	mov    0x4(%eax),%eax
80105578:	f7 d8                	neg    %eax
8010557a:	c1 e0 0c             	shl    $0xc,%eax
8010557d:	05 00 f0 ff 7f       	add    $0x7ffff000,%eax
80105582:	39 f0                	cmp    %esi,%eax
80105584:	0f 87 06 01 00 00    	ja     80105690 <trap+0x170>
      myproc()->pgcount++;
8010558a:	e8 21 e1 ff ff       	call   801036b0 <myproc>
8010558f:	83 40 04 01          	addl   $0x1,0x4(%eax)
      givepteu(myproc()->pgdir, (char*)(KERNBASE - (myproc()->pgcount * PGSIZE)));
80105593:	e8 18 e1 ff ff       	call   801036b0 <myproc>
80105598:	8b 40 04             	mov    0x4(%eax),%eax
8010559b:	f7 d8                	neg    %eax
8010559d:	c1 e0 0c             	shl    $0xc,%eax
801055a0:	8d b0 00 00 00 80    	lea    -0x80000000(%eax),%esi
801055a6:	e8 05 e1 ff ff       	call   801036b0 <myproc>
801055ab:	89 74 24 04          	mov    %esi,0x4(%esp)
801055af:	8b 40 08             	mov    0x8(%eax),%eax
801055b2:	89 04 24             	mov    %eax,(%esp)
801055b5:	e8 06 16 00 00       	call   80106bc0 <givepteu>
      if(allocuvm(myproc()->pgdir, KERNBASE - ((myproc()->pgcount + 1) * PGSIZE), KERNBASE - (myproc()->pgcount * PGSIZE)) == 0) {
801055ba:	e8 f1 e0 ff ff       	call   801036b0 <myproc>
801055bf:	8b 40 04             	mov    0x4(%eax),%eax
801055c2:	f7 d8                	neg    %eax
801055c4:	c1 e0 0c             	shl    $0xc,%eax
801055c7:	8d b0 00 00 00 80    	lea    -0x80000000(%eax),%esi
801055cd:	e8 de e0 ff ff       	call   801036b0 <myproc>
801055d2:	8b 40 04             	mov    0x4(%eax),%eax
801055d5:	f7 d8                	neg    %eax
801055d7:	c1 e0 0c             	shl    $0xc,%eax
801055da:	8d b8 00 f0 ff 7f    	lea    0x7ffff000(%eax),%edi
801055e0:	e8 cb e0 ff ff       	call   801036b0 <myproc>
801055e5:	89 74 24 08          	mov    %esi,0x8(%esp)
801055e9:	89 7c 24 04          	mov    %edi,0x4(%esp)
801055ed:	8b 40 08             	mov    0x8(%eax),%eax
801055f0:	89 04 24             	mov    %eax,(%esp)
801055f3:	e8 48 13 00 00       	call   80106940 <allocuvm>
801055f8:	85 c0                	test   %eax,%eax
801055fa:	0f 85 30 02 00 00    	jne    80105830 <trap+0x310>
        cprintf("Stack Overflow\n");
80105600:	c7 04 24 a6 78 10 80 	movl   $0x801078a6,(%esp)
80105607:	e8 44 b0 ff ff       	call   80100650 <cprintf>
        //cprintf("Address: %x\n", rcr2());
        exit();
8010560c:	e8 9f e4 ff ff       	call   80103ab0 <exit>
...
8010561f:	90                   	nop
80105620:	74 0c                	je     8010562e <trap+0x10e>
80105622:	e8 89 e0 ff ff       	call   801036b0 <myproc>
80105627:	8b 50 28             	mov    0x28(%eax),%edx
8010562a:	85 d2                	test   %edx,%edx
8010562c:	75 4a                	jne    80105678 <trap+0x158>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
8010562e:	e8 7d e0 ff ff       	call   801036b0 <myproc>
80105633:	85 c0                	test   %eax,%eax
80105635:	74 0f                	je     80105646 <trap+0x126>
80105637:	e8 74 e0 ff ff       	call   801036b0 <myproc>
8010563c:	83 78 10 04          	cmpl   $0x4,0x10(%eax)
80105640:	0f 84 da 00 00 00    	je     80105720 <trap+0x200>
...
8010564d:	74 1e                	je     8010566d <trap+0x14d>
8010564f:	90                   	nop
80105650:	e8 5b e0 ff ff       	call   801036b0 <myproc>
80105655:	8b 40 28             	mov    0x28(%eax),%eax
80105658:	85 c0                	test   %eax,%eax
8010565a:	74 11                	je     8010566d <trap+0x14d>
8010565c:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105660:	83 e0 03             	and    $0x3,%eax
80105663:	66 83 f8 03          	cmp    $0x3,%ax
80105667:	0f 84 7c 01 00 00    	je     801057e9 <trap+0x2c9>
    exit();
}
...
80105683:	75 a9                	jne    8010562e <trap+0x10e>
    exit();
80105685:	e8 26 e4 ff ff       	call   80103ab0 <exit>
8010568a:	eb a2                	jmp    8010562e <trap+0x10e>
...
80105690:	e8 1b e0 ff ff       	call   801036b0 <myproc>
80105695:	85 c0                	test   %eax,%eax
80105697:	0f 84 bf 01 00 00    	je     8010585c <trap+0x33c>
8010569d:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
801056a1:	0f 84 b5 01 00 00    	je     8010585c <trap+0x33c>
...
801056b3:	e8 d8 df ff ff       	call   80103690 <cpuid>
...
801056c3:	e8 e8 df ff ff       	call   801036b0 <myproc>
801056c8:	89 45 e0             	mov    %eax,-0x20(%ebp)
801056cb:	e8 e0 df ff ff       	call   801036b0 <myproc>
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
...
801056e1:	8b 7d e4             	mov    -0x1c(%ebp),%edi
801056e4:	89 4c 24 1c          	mov    %ecx,0x1c(%esp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
801056e8:	83 c6 70             	add    $0x70,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
...
801056ef:	89 7c 24 10          	mov    %edi,0x10(%esp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
801056f3:	89 74 24 08          	mov    %esi,0x8(%esp)
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801056f7:	8b 40 14             	mov    0x14(%eax),%eax
801056fa:	c7 04 24 14 79 10 80 	movl   $0x80107914,(%esp)
...
80105705:	e8 46 af ff ff       	call   80100650 <cprintf>
    ...
    myproc()->killed = 1;
8010570a:	e8 a1 df ff ff       	call   801036b0 <myproc>
8010570f:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
80105716:	e9 fd fe ff ff       	jmp    80105618 <trap+0xf8>
8010571b:	90                   	nop
...
80105724:	0f 85 1c ff ff ff    	jne    80105646 <trap+0x126>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
8010572a:	e8 a1 e4 ff ff       	call   80103bd0 <yield>
8010572f:	90                   	nop
80105730:	e9 11 ff ff ff       	jmp    80105646 <trap+0x126>
...
80105739:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105740:	e8 4b df ff ff       	call   80103690 <cpuid>
80105745:	85 c0                	test   %eax,%eax
80105747:	0f 84 b3 00 00 00    	je     80105800 <trap+0x2e0>
...
80105750:	e8 3b d0 ff ff       	call   80102790 <lapiceoi>
    break;
80105755:	e9 be fe ff ff       	jmp    80105618 <trap+0xf8>
...
80105765:	e8 26 d0 ff ff       	call   80102790 <lapiceoi>
    break;
8010576a:	e9 a9 fe ff ff       	jmp    80105618 <trap+0xf8>
8010576f:	90                   	nop
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80105770:	e8 4b 02 00 00       	call   801059c0 <uartintr>
    lapiceoi();
80105775:	e8 16 d0 ff ff       	call   80102790 <lapiceoi>
    break;
8010577a:	e9 99 fe ff ff       	jmp    80105618 <trap+0xf8>
8010577f:	90                   	nop
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
...
80105787:	e8 04 df ff ff       	call   80103690 <cpuid>
8010578c:	c7 04 24 bc 78 10 80 	movl   $0x801078bc,(%esp)
...
801057a4:	eb a7                	jmp    8010574d <trap+0x22d>
801057a6:	66 90                	xchg   %ax,%ax
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801057a8:	e8 e3 c8 ff ff       	call   80102090 <ideintr>
801057ad:	8d 76 00             	lea    0x0(%esi),%esi
    lapiceoi();
801057b0:	e8 db cf ff ff       	call   80102790 <lapiceoi>
    break;
801057b5:	e9 5e fe ff ff       	jmp    80105618 <trap+0xf8>
...
801057c5:	8b 70 28             	mov    0x28(%eax),%esi
801057c8:	85 f6                	test   %esi,%esi
801057ca:	75 2c                	jne    801057f8 <trap+0x2d8>
      exit();
    myproc()->tf = tf;
801057cc:	e8 df de ff ff       	call   801036b0 <myproc>
801057d1:	89 58 1c             	mov    %ebx,0x1c(%eax)
    syscall();
801057d4:	e8 57 ee ff ff       	call   80104630 <syscall>
    if(myproc()->killed)
801057d9:	e8 d2 de ff ff       	call   801036b0 <myproc>
801057de:	8b 48 28             	mov    0x28(%eax),%ecx
801057e1:	85 c9                	test   %ecx,%ecx
801057e3:	0f 84 84 fe ff ff    	je     8010566d <trap+0x14d>
    yield();
...
801057ef:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
801057f0:	e9 bb e2 ff ff       	jmp    80103ab0 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
801057f8:	e8 b3 e2 ff ff       	call   80103ab0 <exit>
801057fd:	eb cd                	jmp    801057cc <trap+0x2ac>
801057ff:	90                   	nop
  }
...
80105807:	e8 44 e9 ff ff       	call   80104150 <acquire>
      ticks++;
      wakeup(&ticks);
...
80105813:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
8010581a:	e8 81 e5 ff ff       	call   80103da0 <wakeup>
      release(&tickslock);
8010581f:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105826:	e8 15 ea ff ff       	call   80104240 <release>
8010582b:	e9 1d ff ff ff       	jmp    8010574d <trap+0x22d>
        cprintf("Stack Overflow\n");
        //cprintf("Address: %x\n", rcr2());
        exit();
      } 
...
80105830:	e8 7b de ff ff       	call   801036b0 <myproc>
80105835:	8b 40 04             	mov    0x4(%eax),%eax
80105838:	f7 d8                	neg    %eax
8010583a:	c1 e0 0c             	shl    $0xc,%eax
8010583d:	8d b0 00 f0 ff 7f    	lea    0x7ffff000(%eax),%esi
80105843:	e8 68 de ff ff       	call   801036b0 <myproc>
80105848:	89 74 24 04          	mov    %esi,0x4(%esp)
8010584c:	8b 40 08             	mov    0x8(%eax),%eax
8010584f:	89 04 24             	mov    %eax,(%esp)
80105852:	e8 39 13 00 00       	call   80106b90 <clearpteu>
80105857:	e9 bc fd ff ff       	jmp    80105618 <trap+0xf8>
8010585c:	0f 20 d7             	mov    %cr2,%edi
    //
  //PAGEBREAK: 13
  default:
    if(myproc() == 0 || (tf->cs&3) == 0){
      ...
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010585f:	8b 73 38             	mov    0x38(%ebx),%esi
80105862:	e8 29 de ff ff       	call   80103690 <cpuid>
80105867:	89 7c 24 10          	mov    %edi,0x10(%esp)
8010586b:	89 74 24 0c          	mov    %esi,0xc(%esp)
8010586f:	89 44 24 08          	mov    %eax,0x8(%esp)
80105873:	8b 43 30             	mov    0x30(%ebx),%eax
80105876:	c7 04 24 e0 78 10 80 	movl   $0x801078e0,(%esp)
8010587d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105881:	e8 ca ad ff ff       	call   80100650 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
80105886:	c7 04 24 b6 78 10 80 	movl   $0x801078b6,(%esp)
8010588d:	e8 ce aa ff ff       	call   80100360 <panic>
...
801058f7:	e8 b4 ce ff ff       	call   801027b0 <microdelay>
{
  int i;
...
80105928:	bf fa 03 00 00       	mov    $0x3fa,%edi
8010592d:	56                   	push   %esi
8010592e:	89 fa                	mov    %edi,%edx
80105930:	53                   	push   %ebx
80105931:	83 ec 1c             	sub    $0x1c,%esp
80105934:	ee                   	out    %al,(%dx)
80105935:	be fb 03 00 00       	mov    $0x3fb,%esi
8010593a:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
8010593f:	89 f2                	mov    %esi,%edx
80105941:	ee                   	out    %al,(%dx)
80105942:	b8 0c 00 00 00       	mov    $0xc,%eax
80105947:	b2 f8                	mov    $0xf8,%dl
80105949:	ee                   	out    %al,(%dx)
8010594a:	bb f9 03 00 00       	mov    $0x3f9,%ebx
8010594f:	89 c8                	mov    %ecx,%eax
80105951:	89 da                	mov    %ebx,%edx
80105953:	ee                   	out    %al,(%dx)
80105954:	b8 03 00 00 00       	mov    $0x3,%eax
80105959:	89 f2                	mov    %esi,%edx
8010595b:	ee                   	out    %al,(%dx)
8010595c:	b2 fc                	mov    $0xfc,%dl
8010595e:	89 c8                	mov    %ecx,%eax
80105960:	ee                   	out    %al,(%dx)
80105961:	b8 01 00 00 00       	mov    $0x1,%eax
80105966:	89 da                	mov    %ebx,%edx
80105968:	ee                   	out    %al,(%dx)
static inline uchar
inb(ushort port)
{
  uchar data;
...
8010596b:	ec                   	in     (%dx),%al
  ...
  if(inb(COM1+5) == 0xFF)
8010596c:	3c ff                	cmp    $0xff,%al
8010596e:	74 42                	je     801059b2 <uartinit+0x92>
    return;
  uart = 1;
80105970:	c7 05 bc a5 10 80 01 	movl   $0x1,0x8010a5bc
80105977:	00 00 00 
8010597a:	89 fa                	mov    %edi,%edx
...
80105987:	00 
  ...
  for(p="xv6...\n"; *p; p++)
80105988:	bb 20 7a 10 80       	mov    $0x80107a20,%ebx
...
80105994:	e8 27 c9 ff ff       	call   801022c0 <ioapicenable>
...
801059a3:	83 c3 01             	add    $0x1,%ebx
    uartputc(*p);
801059a6:	e8 25 ff ff ff       	call   801058d0 <uartputc>
  inb(COM1+2);
  inb(COM1+0);
  ioapicenable(IRQ_COM1, 0);
...
801059b0:	75 ee                	jne    801059a0 <uartinit+0x80>
    uartputc(*p);
}
...
801059c6:	c7 04 24 a0 58 10 80 	movl   $0x801058a0,(%esp)
...
801059d6:	6a 00                	push   $0x0
  jmp alltraps
801059d8:	e9 50 fa ff ff       	jmp    8010542d <alltraps>
...
801059df:	6a 01                	push   $0x1
  jmp alltraps
801059e1:	e9 47 fa ff ff       	jmp    8010542d <alltraps>
...
80105a03:	6a 05                	push   $0x5
  jmp alltraps
80105a05:	e9 23 fa ff ff       	jmp    8010542d <alltraps>
...
80105a0c:	6a 06                	push   $0x6
  jmp alltraps
80105a0e:	e9 1a fa ff ff       	jmp    8010542d <alltraps>
...
80105a15:	6a 07                	push   $0x7
  jmp alltraps
80105a17:	e9 11 fa ff ff       	jmp    8010542d <alltraps>
...
80105a2c:	6a 0a                	push   $0xa
  jmp alltraps
80105a2e:	e9 fa f9 ff ff       	jmp    8010542d <alltraps>
...
80105a33:	6a 0b                	push   $0xb
  jmp alltraps
80105a35:	e9 f3 f9 ff ff       	jmp    8010542d <alltraps>
...
80105a3a:	6a 0c                	push   $0xc
  jmp alltraps
80105a3c:	e9 ec f9 ff ff       	jmp    8010542d <alltraps>
...
80105a48:	6a 0e                	push   $0xe
  jmp alltraps
80105a4a:	e9 de f9 ff ff       	jmp    8010542d <alltraps>
...
80105a51:	6a 0f                	push   $0xf
  jmp alltraps
80105a53:	e9 d5 f9 ff ff       	jmp    8010542d <alltraps>
...
80105a5a:	6a 10                	push   $0x10
  jmp alltraps
80105a5c:	e9 cc f9 ff ff       	jmp    8010542d <alltraps>
...
80105a61:	6a 11                	push   $0x11
  jmp alltraps
80105a63:	e9 c5 f9 ff ff       	jmp    8010542d <alltraps>
...
80105a6a:	6a 12                	push   $0x12
  jmp alltraps
80105a6c:	e9 bc f9 ff ff       	jmp    8010542d <alltraps>
...
80105a73:	6a 13                	push   $0x13
  jmp alltraps
80105a75:	e9 b3 f9 ff ff       	jmp    8010542d <alltraps>
...
80105a7c:	6a 14                	push   $0x14
  jmp alltraps
80105a7e:	e9 aa f9 ff ff       	jmp    8010542d <alltraps>
...
80105a85:	6a 15                	push   $0x15
  jmp alltraps
80105a87:	e9 a1 f9 ff ff       	jmp    8010542d <alltraps>
...
80105a8e:	6a 16                	push   $0x16
  jmp alltraps
80105a90:	e9 98 f9 ff ff       	jmp    8010542d <alltraps>
...
80105a97:	6a 17                	push   $0x17
  jmp alltraps
80105a99:	e9 8f f9 ff ff       	jmp    8010542d <alltraps>
...
80105aa0:	6a 18                	push   $0x18
  jmp alltraps
80105aa2:	e9 86 f9 ff ff       	jmp    8010542d <alltraps>
...
80105aa9:	6a 19                	push   $0x19
  jmp alltraps
80105aab:	e9 7d f9 ff ff       	jmp    8010542d <alltraps>
...
80105ab2:	6a 1a                	push   $0x1a
  jmp alltraps
80105ab4:	e9 74 f9 ff ff       	jmp    8010542d <alltraps>
...
80105abb:	6a 1b                	push   $0x1b
  jmp alltraps
80105abd:	e9 6b f9 ff ff       	jmp    8010542d <alltraps>
...
80105ac4:	6a 1c                	push   $0x1c
  jmp alltraps
80105ac6:	e9 62 f9 ff ff       	jmp    8010542d <alltraps>
...
80105acd:	6a 1d                	push   $0x1d
  jmp alltraps
80105acf:	e9 59 f9 ff ff       	jmp    8010542d <alltraps>
...
80105ad6:	6a 1e                	push   $0x1e
  jmp alltraps
80105ad8:	e9 50 f9 ff ff       	jmp    8010542d <alltraps>
...
80105adf:	6a 1f                	push   $0x1f
  jmp alltraps
80105ae1:	e9 47 f9 ff ff       	jmp    8010542d <alltraps>
...
80105ae8:	6a 20                	push   $0x20
  jmp alltraps
80105aea:	e9 3e f9 ff ff       	jmp    8010542d <alltraps>
...
80105af1:	6a 21                	push   $0x21
  jmp alltraps
80105af3:	e9 35 f9 ff ff       	jmp    8010542d <alltraps>
...
80105afa:	6a 22                	push   $0x22
  jmp alltraps
80105afc:	e9 2c f9 ff ff       	jmp    8010542d <alltraps>
...
80105b03:	6a 23                	push   $0x23
  jmp alltraps
80105b05:	e9 23 f9 ff ff       	jmp    8010542d <alltraps>
...
80105b0c:	6a 24                	push   $0x24
  jmp alltraps
80105b0e:	e9 1a f9 ff ff       	jmp    8010542d <alltraps>
...
80105b15:	6a 25                	push   $0x25
  jmp alltraps
80105b17:	e9 11 f9 ff ff       	jmp    8010542d <alltraps>
...
80105b1e:	6a 26                	push   $0x26
  jmp alltraps
80105b20:	e9 08 f9 ff ff       	jmp    8010542d <alltraps>
...
80105b27:	6a 27                	push   $0x27
  jmp alltraps
80105b29:	e9 ff f8 ff ff       	jmp    8010542d <alltraps>
...
80105b30:	6a 28                	push   $0x28
  jmp alltraps
80105b32:	e9 f6 f8 ff ff       	jmp    8010542d <alltraps>
...
80105b39:	6a 29                	push   $0x29
  jmp alltraps
80105b3b:	e9 ed f8 ff ff       	jmp    8010542d <alltraps>
...
80105b42:	6a 2a                	push   $0x2a
  jmp alltraps
80105b44:	e9 e4 f8 ff ff       	jmp    8010542d <alltraps>
...
80105b4b:	6a 2b                	push   $0x2b
  jmp alltraps
80105b4d:	e9 db f8 ff ff       	jmp    8010542d <alltraps>
...
80105b54:	6a 2c                	push   $0x2c
  jmp alltraps
80105b56:	e9 d2 f8 ff ff       	jmp    8010542d <alltraps>
...
80105b5d:	6a 2d                	push   $0x2d
  jmp alltraps
80105b5f:	e9 c9 f8 ff ff       	jmp    8010542d <alltraps>
...
80105b66:	6a 2e                	push   $0x2e
  jmp alltraps
80105b68:	e9 c0 f8 ff ff       	jmp    8010542d <alltraps>
...
80105b6f:	6a 2f                	push   $0x2f
  jmp alltraps
80105b71:	e9 b7 f8 ff ff       	jmp    8010542d <alltraps>
...
80105b78:	6a 30                	push   $0x30
  jmp alltraps
80105b7a:	e9 ae f8 ff ff       	jmp    8010542d <alltraps>
...
80105b81:	6a 31                	push   $0x31
  jmp alltraps
80105b83:	e9 a5 f8 ff ff       	jmp    8010542d <alltraps>
...
80105b8a:	6a 32                	push   $0x32
  jmp alltraps
80105b8c:	e9 9c f8 ff ff       	jmp    8010542d <alltraps>
...
80105b93:	6a 33                	push   $0x33
  jmp alltraps
80105b95:	e9 93 f8 ff ff       	jmp    8010542d <alltraps>
...
80105b9c:	6a 34                	push   $0x34
  jmp alltraps
80105b9e:	e9 8a f8 ff ff       	jmp    8010542d <alltraps>
...
80105ba5:	6a 35                	push   $0x35
  jmp alltraps
80105ba7:	e9 81 f8 ff ff       	jmp    8010542d <alltraps>
...
80105bae:	6a 36                	push   $0x36
  jmp alltraps
80105bb0:	e9 78 f8 ff ff       	jmp    8010542d <alltraps>
...
80105bb7:	6a 37                	push   $0x37
  jmp alltraps
80105bb9:	e9 6f f8 ff ff       	jmp    8010542d <alltraps>
...
80105bc0:	6a 38                	push   $0x38
  jmp alltraps
80105bc2:	e9 66 f8 ff ff       	jmp    8010542d <alltraps>
...
80105bc9:	6a 39                	push   $0x39
  jmp alltraps
80105bcb:	e9 5d f8 ff ff       	jmp    8010542d <alltraps>
...
80105bd2:	6a 3a                	push   $0x3a
  jmp alltraps
80105bd4:	e9 54 f8 ff ff       	jmp    8010542d <alltraps>
...
80105bdb:	6a 3b                	push   $0x3b
  jmp alltraps
80105bdd:	e9 4b f8 ff ff       	jmp    8010542d <alltraps>
...
80105be4:	6a 3c                	push   $0x3c
  jmp alltraps
80105be6:	e9 42 f8 ff ff       	jmp    8010542d <alltraps>
...
80105bed:	6a 3d                	push   $0x3d
  jmp alltraps
80105bef:	e9 39 f8 ff ff       	jmp    8010542d <alltraps>
...
80105bf6:	6a 3e                	push   $0x3e
  jmp alltraps
80105bf8:	e9 30 f8 ff ff       	jmp    8010542d <alltraps>
...
80105bff:	6a 3f                	push   $0x3f
  jmp alltraps
80105c01:	e9 27 f8 ff ff       	jmp    8010542d <alltraps>
...
80105c08:	6a 40                	push   $0x40
  jmp alltraps
80105c0a:	e9 1e f8 ff ff       	jmp    8010542d <alltraps>
...
80105c11:	6a 41                	push   $0x41
  jmp alltraps
80105c13:	e9 15 f8 ff ff       	jmp    8010542d <alltraps>
...
80105c1a:	6a 42                	push   $0x42
  jmp alltraps
80105c1c:	e9 0c f8 ff ff       	jmp    8010542d <alltraps>
...
80105c23:	6a 43                	push   $0x43
  jmp alltraps
80105c25:	e9 03 f8 ff ff       	jmp    8010542d <alltraps>
...
80105c2c:	6a 44                	push   $0x44
  jmp alltraps
80105c2e:	e9 fa f7 ff ff       	jmp    8010542d <alltraps>
...
80105c35:	6a 45                	push   $0x45
  jmp alltraps
80105c37:	e9 f1 f7 ff ff       	jmp    8010542d <alltraps>
...
80105c3e:	6a 46                	push   $0x46
  jmp alltraps
80105c40:	e9 e8 f7 ff ff       	jmp    8010542d <alltraps>
...
80105c47:	6a 47                	push   $0x47
  jmp alltraps
80105c49:	e9 df f7 ff ff       	jmp    8010542d <alltraps>
...
80105c50:	6a 48                	push   $0x48
  jmp alltraps
80105c52:	e9 d6 f7 ff ff       	jmp    8010542d <alltraps>
...
80105c59:	6a 49                	push   $0x49
  jmp alltraps
80105c5b:	e9 cd f7 ff ff       	jmp    8010542d <alltraps>
...
80105c62:	6a 4a                	push   $0x4a
  jmp alltraps
80105c64:	e9 c4 f7 ff ff       	jmp    8010542d <alltraps>
...
80105c6b:	6a 4b                	push   $0x4b
  jmp alltraps
80105c6d:	e9 bb f7 ff ff       	jmp    8010542d <alltraps>
...
80105c74:	6a 4c                	push   $0x4c
  jmp alltraps
80105c76:	e9 b2 f7 ff ff       	jmp    8010542d <alltraps>
...
80105c7d:	6a 4d                	push   $0x4d
  jmp alltraps
80105c7f:	e9 a9 f7 ff ff       	jmp    8010542d <alltraps>
...
80105c86:	6a 4e                	push   $0x4e
  jmp alltraps
80105c88:	e9 a0 f7 ff ff       	jmp    8010542d <alltraps>
...
80105c8f:	6a 4f                	push   $0x4f
  jmp alltraps
80105c91:	e9 97 f7 ff ff       	jmp    8010542d <alltraps>
...
80105c98:	6a 50                	push   $0x50
  jmp alltraps
80105c9a:	e9 8e f7 ff ff       	jmp    8010542d <alltraps>
...
80105ca1:	6a 51                	push   $0x51
  jmp alltraps
80105ca3:	e9 85 f7 ff ff       	jmp    8010542d <alltraps>
...
80105caa:	6a 52                	push   $0x52
  jmp alltraps
80105cac:	e9 7c f7 ff ff       	jmp    8010542d <alltraps>
...
80105cb3:	6a 53                	push   $0x53
  jmp alltraps
80105cb5:	e9 73 f7 ff ff       	jmp    8010542d <alltraps>
...
80105cbc:	6a 54                	push   $0x54
  jmp alltraps
80105cbe:	e9 6a f7 ff ff       	jmp    8010542d <alltraps>
...
80105cc5:	6a 55                	push   $0x55
  jmp alltraps
80105cc7:	e9 61 f7 ff ff       	jmp    8010542d <alltraps>
...
80105cce:	6a 56                	push   $0x56
  jmp alltraps
80105cd0:	e9 58 f7 ff ff       	jmp    8010542d <alltraps>
...
80105cd7:	6a 57                	push   $0x57
  jmp alltraps
80105cd9:	e9 4f f7 ff ff       	jmp    8010542d <alltraps>
...
80105ce0:	6a 58                	push   $0x58
  jmp alltraps
80105ce2:	e9 46 f7 ff ff       	jmp    8010542d <alltraps>
...
80105ce9:	6a 59                	push   $0x59
  jmp alltraps
80105ceb:	e9 3d f7 ff ff       	jmp    8010542d <alltraps>
...
80105cf2:	6a 5a                	push   $0x5a
  jmp alltraps
80105cf4:	e9 34 f7 ff ff       	jmp    8010542d <alltraps>
...
80105cfb:	6a 5b                	push   $0x5b
  jmp alltraps
80105cfd:	e9 2b f7 ff ff       	jmp    8010542d <alltraps>
...
80105d04:	6a 5c                	push   $0x5c
  jmp alltraps
80105d06:	e9 22 f7 ff ff       	jmp    8010542d <alltraps>
...
80105d0d:	6a 5d                	push   $0x5d
  jmp alltraps
80105d0f:	e9 19 f7 ff ff       	jmp    8010542d <alltraps>
...
80105d16:	6a 5e                	push   $0x5e
  jmp alltraps
80105d18:	e9 10 f7 ff ff       	jmp    8010542d <alltraps>
...
80105d1f:	6a 5f                	push   $0x5f
  jmp alltraps
80105d21:	e9 07 f7 ff ff       	jmp    8010542d <alltraps>
...
80105d28:	6a 60                	push   $0x60
  jmp alltraps
80105d2a:	e9 fe f6 ff ff       	jmp    8010542d <alltraps>
...
80105d31:	6a 61                	push   $0x61
  jmp alltraps
80105d33:	e9 f5 f6 ff ff       	jmp    8010542d <alltraps>
...
80105d3a:	6a 62                	push   $0x62
  jmp alltraps
80105d3c:	e9 ec f6 ff ff       	jmp    8010542d <alltraps>
...
80105d43:	6a 63                	push   $0x63
  jmp alltraps
80105d45:	e9 e3 f6 ff ff       	jmp    8010542d <alltraps>
...
80105d4c:	6a 64                	push   $0x64
  jmp alltraps
80105d4e:	e9 da f6 ff ff       	jmp    8010542d <alltraps>
...
80105d55:	6a 65                	push   $0x65
  jmp alltraps
80105d57:	e9 d1 f6 ff ff       	jmp    8010542d <alltraps>
...
80105d5e:	6a 66                	push   $0x66
  jmp alltraps
80105d60:	e9 c8 f6 ff ff       	jmp    8010542d <alltraps>
...
80105d67:	6a 67                	push   $0x67
  jmp alltraps
80105d69:	e9 bf f6 ff ff       	jmp    8010542d <alltraps>
...
80105d70:	6a 68                	push   $0x68
  jmp alltraps
80105d72:	e9 b6 f6 ff ff       	jmp    8010542d <alltraps>
...
80105d79:	6a 69                	push   $0x69
  jmp alltraps
80105d7b:	e9 ad f6 ff ff       	jmp    8010542d <alltraps>
...
80105d82:	6a 6a                	push   $0x6a
  jmp alltraps
80105d84:	e9 a4 f6 ff ff       	jmp    8010542d <alltraps>
...
80105d8b:	6a 6b                	push   $0x6b
  jmp alltraps
80105d8d:	e9 9b f6 ff ff       	jmp    8010542d <alltraps>
...
80105d94:	6a 6c                	push   $0x6c
  jmp alltraps
80105d96:	e9 92 f6 ff ff       	jmp    8010542d <alltraps>
...
80105d9d:	6a 6d                	push   $0x6d
  jmp alltraps
80105d9f:	e9 89 f6 ff ff       	jmp    8010542d <alltraps>
...
80105da6:	6a 6e                	push   $0x6e
  jmp alltraps
80105da8:	e9 80 f6 ff ff       	jmp    8010542d <alltraps>
...
80105daf:	6a 6f                	push   $0x6f
  jmp alltraps
80105db1:	e9 77 f6 ff ff       	jmp    8010542d <alltraps>
...
80105db8:	6a 70                	push   $0x70
  jmp alltraps
80105dba:	e9 6e f6 ff ff       	jmp    8010542d <alltraps>
...
80105dc1:	6a 71                	push   $0x71
  jmp alltraps
80105dc3:	e9 65 f6 ff ff       	jmp    8010542d <alltraps>
...
80105dca:	6a 72                	push   $0x72
  jmp alltraps
80105dcc:	e9 5c f6 ff ff       	jmp    8010542d <alltraps>
...
80105dd3:	6a 73                	push   $0x73
  jmp alltraps
80105dd5:	e9 53 f6 ff ff       	jmp    8010542d <alltraps>
...
80105ddc:	6a 74                	push   $0x74
  jmp alltraps
80105dde:	e9 4a f6 ff ff       	jmp    8010542d <alltraps>
...
80105de5:	6a 75                	push   $0x75
  jmp alltraps
80105de7:	e9 41 f6 ff ff       	jmp    8010542d <alltraps>
...
80105dee:	6a 76                	push   $0x76
  jmp alltraps
80105df0:	e9 38 f6 ff ff       	jmp    8010542d <alltraps>
...
80105e00:	6a 78                	push   $0x78
  jmp alltraps
80105e02:	e9 26 f6 ff ff       	jmp    8010542d <alltraps>
...
80105e09:	6a 79                	push   $0x79
  jmp alltraps
80105e0b:	e9 1d f6 ff ff       	jmp    8010542d <alltraps>
...
80105e12:	6a 7a                	push   $0x7a
  jmp alltraps
80105e14:	e9 14 f6 ff ff       	jmp    8010542d <alltraps>
...
80105e24:	6a 7c                	push   $0x7c
  jmp alltraps
80105e26:	e9 02 f6 ff ff       	jmp    8010542d <alltraps>
...
80105e2d:	6a 7d                	push   $0x7d
  jmp alltraps
80105e2f:	e9 f9 f5 ff ff       	jmp    8010542d <alltraps>
...
80105e36:	6a 7e                	push   $0x7e
  jmp alltraps
80105e38:	e9 f0 f5 ff ff       	jmp    8010542d <alltraps>
...
801063e8:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801063ed:	e9 3b f0 ff ff       	jmp    8010542d <alltraps>
...
801063f4:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801063f9:	e9 2f f0 ff ff       	jmp    8010542d <alltraps>
...
80106400:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106405:	e9 23 f0 ff ff       	jmp    8010542d <alltraps>
...
8010640c:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106411:	e9 17 f0 ff ff       	jmp    8010542d <alltraps>
...
80106418:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010641d:	e9 0b f0 ff ff       	jmp    8010542d <alltraps>
...
80106424:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106429:	e9 ff ef ff ff       	jmp    8010542d <alltraps>
...
80106430:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106435:	e9 f3 ef ff ff       	jmp    8010542d <alltraps>
...
8010643c:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106441:	e9 e7 ef ff ff       	jmp    8010542d <alltraps>
...
80106494:	e8 17 c0 ff ff       	call   801024b0 <kalloc>
...
801064b2:	e8 d9 dd ff ff       	call   80104290 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801064e9:	53                   	push   %ebx
  ...
  a = PGROUNDUP(newsz);
801064ea:	8d 99 ff 0f 00 00    	lea    0xfff(%ecx),%ebx
// Deallocate user pages to bring the process size from oldsz to
// newsz.  oldsz and newsz need not be page-aligned, nor does newsz
// need to be less than oldsz.  oldsz can be larger than the actual
// process size.  Returns the new process size.
...
801064f0:	83 ec 1c             	sub    $0x1c,%esp
  ...
  a = PGROUNDUP(newsz);
801064f3:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
801064f9:	39 d3                	cmp    %edx,%ebx
// Deallocate user pages to bring the process size from oldsz to
// newsz.  oldsz and newsz need not be page-aligned, nor does newsz
// need to be less than oldsz.  oldsz can be larger than the actual
// process size.  Returns the new process size.
int
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
801064fb:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
801064fe:	72 3b                	jb     8010653b <deallocuvm.part.0+0x5b>
80106500:	eb 5e                	jmp    80106560 <deallocuvm.part.0+0x80>
80106502:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
    else if((*pte & PTE_P) != 0){
80106508:	8b 10                	mov    (%eax),%edx
8010650a:	f6 c2 01             	test   $0x1,%dl
8010650d:	74 22                	je     80106531 <deallocuvm.part.0+0x51>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
8010650f:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80106515:	74 54                	je     8010656b <deallocuvm.part.0+0x8b>
        panic("kfree");
      char *v = P2V(pa);
80106517:	81 c2 00 00 00 80    	add    $0x80000000,%edx
      kfree(v);
8010651d:	89 14 24             	mov    %edx,(%esp)
80106520:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106523:	e8 d8 bd ff ff       	call   80102300 <kfree>
      *pte = 0;
80106528:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010652b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
80106531:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106537:	39 f3                	cmp    %esi,%ebx
80106539:	73 25                	jae    80106560 <deallocuvm.part.0+0x80>
    pte = walkpgdir(pgdir, (char*)a, 0);
8010653b:	31 c9                	xor    %ecx,%ecx
8010653d:	89 da                	mov    %ebx,%edx
8010653f:	89 f8                	mov    %edi,%eax
80106541:	e8 0a ff ff ff       	call   80106450 <walkpgdir>
    if(!pte)
80106546:	85 c0                	test   %eax,%eax
80106548:	75 be                	jne    80106508 <deallocuvm.part.0+0x28>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
8010654a:	81 e3 00 00 c0 ff    	and    $0xffc00000,%ebx
80106550:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
...
8010655c:	39 f3                	cmp    %esi,%ebx
8010655e:	72 db                	jb     8010653b <deallocuvm.part.0+0x5b>
      kfree(v);
      *pte = 0;
    }
  }
...
80106560:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106563:	83 c4 1c             	add    $0x1c,%esp
80106566:	5b                   	pop    %ebx
80106567:	5e                   	pop    %esi
80106568:	5f                   	pop    %edi
80106569:	5d                   	pop    %ebp
8010656a:	c3                   	ret    
    if(!pte)
      ...
      if(pa == 0)
        panic("kfree");
8010656b:	c7 04 24 66 73 10 80 	movl   $0x80107366,(%esp)
80106572:	e8 e9 9d ff ff       	call   80100360 <panic>
...
80106583:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
80106586:	e8 05 d1 ff ff       	call   80103690 <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010658b:	31 c9                	xor    %ecx,%ecx
8010658d:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  ...
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
80106592:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80106598:	05 80 27 11 80       	add    $0x80112780,%eax
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010659d:	66 89 50 78          	mov    %dx,0x78(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801065a1:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
  lgdt(c->gdt, sizeof(c->gdt));
801065a6:	83 c0 70             	add    $0x70,%eax
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801065a9:	66 89 48 0a          	mov    %cx,0xa(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801065ad:	31 c9                	xor    %ecx,%ecx
801065af:	66 89 50 10          	mov    %dx,0x10(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801065b3:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801065b8:	66 89 48 12          	mov    %cx,0x12(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801065bc:	31 c9                	xor    %ecx,%ecx
801065be:	66 89 50 18          	mov    %dx,0x18(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801065c2:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801065c7:	66 89 48 1a          	mov    %cx,0x1a(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801065cb:	31 c9                	xor    %ecx,%ecx
  ...
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801065cd:	c6 40 0d 9a          	movb   $0x9a,0xd(%eax)
801065d1:	c6 40 0e cf          	movb   $0xcf,0xe(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801065d5:	c6 40 15 92          	movb   $0x92,0x15(%eax)
801065d9:	c6 40 16 cf          	movb   $0xcf,0x16(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801065dd:	c6 40 1d fa          	movb   $0xfa,0x1d(%eax)
801065e1:	c6 40 1e cf          	movb   $0xcf,0x1e(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801065e5:	c6 40 25 f2          	movb   $0xf2,0x25(%eax)
801065e9:	c6 40 26 cf          	movb   $0xcf,0x26(%eax)
801065ed:	66 89 50 20          	mov    %dx,0x20(%eax)
static inline void
lgdt(struct segdesc *p, int size)
{
  ...
  pd[0] = size-1;
801065f1:	ba 2f 00 00 00       	mov    $0x2f,%edx
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801065f6:	c6 40 0c 00          	movb   $0x0,0xc(%eax)
801065fa:	c6 40 0f 00          	movb   $0x0,0xf(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801065fe:	c6 40 14 00          	movb   $0x0,0x14(%eax)
80106602:	c6 40 17 00          	movb   $0x0,0x17(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106606:	c6 40 1c 00          	movb   $0x0,0x1c(%eax)
8010660a:	c6 40 1f 00          	movb   $0x0,0x1f(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
8010660e:	66 89 48 22          	mov    %cx,0x22(%eax)
80106612:	c6 40 24 00          	movb   $0x0,0x24(%eax)
80106616:	c6 40 27 00          	movb   $0x0,0x27(%eax)
8010661a:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  pd[1] = (uint)p;
8010661e:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80106622:	c1 e8 10             	shr    $0x10,%eax
80106625:	66 89 45 f6          	mov    %ax,-0xa(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80106629:	8d 45 f2             	lea    -0xe(%ebp),%eax
8010662c:	0f 01 10             	lgdtl  (%eax)
  lgdt(c->gdt, sizeof(c->gdt));
}
8010662f:	c9                   	leave  
80106630:	c3                   	ret    
80106631:	eb 0d                	jmp    80106640 <mappages>
80106633:	90                   	nop
80106634:	90                   	nop
80106635:	90                   	nop
80106636:	90                   	nop
...
8010664c:	8b 55 10             	mov    0x10(%ebp),%edx
// Create PTEs for virtual addresses starting at va that refer to
// physical addresses starting at pa. va and size might not
// be page-aligned.
int
mappages(pde_t *pgdir, void *va, uint size, uint pa, int perm)
{
8010664f:	8b 7d 14             	mov    0x14(%ebp),%edi
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
80106652:	83 4d 18 01          	orl    $0x1,0x18(%ebp)
mappages(pde_t *pgdir, void *va, uint size, uint pa, int perm)
{
  char *a, *last;
  pte_t *pte;
  ...
  a = (char*)PGROUNDDOWN((uint)va);
80106656:	89 c3                	mov    %eax,%ebx
80106658:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
8010665e:	8d 44 10 ff          	lea    -0x1(%eax,%edx,1),%eax
80106662:	29 df                	sub    %ebx,%edi
80106664:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106667:	81 65 e4 00 f0 ff ff 	andl   $0xfffff000,-0x1c(%ebp)
...
80106673:	75 3d                	jne    801066b2 <mappages+0x72>
      panic("remap");
    *pte = pa | perm | PTE_P;
80106675:	0b 75 18             	or     0x18(%ebp),%esi
    if(a == last)
80106678:	3b 5d e4             	cmp    -0x1c(%ebp),%ebx
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
      return -1;
    if(*pte & PTE_P)
...
8010667b:	89 30                	mov    %esi,(%eax)
    if(a == last)
8010667d:	74 29                	je     801066a8 <mappages+0x68>
      break;
    a += PGSIZE;
...
80106692:	e8 b9 fd ff ff       	call   80106450 <walkpgdir>
...
8010669b:	83 c4 1c             	add    $0x1c,%esp
...
801066b1:	c3                   	ret    
  ...
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
801066b2:	c7 04 24 28 7a 10 80 	movl   $0x80107a28,(%esp)
801066b9:	e8 a2 9c ff ff       	call   80100360 <panic>
...
801066c0:	a1 a4 55 11 80       	mov    0x801155a4,%eax
...
801066ee:	0f 84 cd 00 00 00    	je     801067c1 <switchuvm+0xe1>
  ...
  if(p->kstack == 0)
801066f4:	8b 46 0c             	mov    0xc(%esi),%eax
801066f7:	85 c0                	test   %eax,%eax
801066f9:	0f 84 da 00 00 00    	je     801067d9 <switchuvm+0xf9>
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
801066ff:	8b 7e 08             	mov    0x8(%esi),%edi
80106702:	85 ff                	test   %edi,%edi
80106704:	0f 84 c3 00 00 00    	je     801067cd <switchuvm+0xed>
    panic("switchuvm: no pgdir");

  pushcli();
8010670a:	e8 01 da ff ff       	call   80104110 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010670f:	e8 fc ce ff ff       	call   80103610 <mycpu>
80106714:	89 c3                	mov    %eax,%ebx
80106716:	e8 f5 ce ff ff       	call   80103610 <mycpu>
8010671b:	89 c7                	mov    %eax,%edi
8010671d:	e8 ee ce ff ff       	call   80103610 <mycpu>
...
801067aa:	8b 46 08             	mov    0x8(%esi),%eax
...
801067bb:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
801067bc:	e9 0f da ff ff       	jmp    801041d0 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
801067c1:	c7 04 24 2e 7a 10 80 	movl   $0x80107a2e,(%esp)
801067c8:	e8 93 9b ff ff       	call   80100360 <panic>
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
801067cd:	c7 04 24 59 7a 10 80 	movl   $0x80107a59,(%esp)
...
switchuvm(struct proc *p)
{
  ...
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
801067d9:	c7 04 24 44 7a 10 80 	movl   $0x80107a44,(%esp)
...
80106808:	77 64                	ja     8010686e <inituvm+0x7e>
8010680a:	89 55 e4             	mov    %edx,-0x1c(%ebp)
    panic("inituvm: more than a page");
  mem = kalloc();
8010680d:	e8 9e bc ff ff       	call   801024b0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106822:	89 04 24             	mov    %eax,(%esp)
{
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
  mem = kalloc();
80106825:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80106827:	e8 64 da ff ff       	call   80104290 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
8010682c:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010682f:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106835:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
8010683c:	00 
8010683d:	89 44 24 0c          	mov    %eax,0xc(%esp)
80106841:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106848:	00 
80106849:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106850:	00 
80106851:	89 14 24             	mov    %edx,(%esp)
80106854:	e8 e7 fd ff ff       	call   80106640 <mappages>
  memmove(mem, init, sz);
80106859:	89 75 10             	mov    %esi,0x10(%ebp)
8010685c:	89 7d 0c             	mov    %edi,0xc(%ebp)
8010685f:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
80106862:	83 c4 2c             	add    $0x2c,%esp
80106865:	5b                   	pop    %ebx
80106866:	5e                   	pop    %esi
80106867:	5f                   	pop    %edi
80106868:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80106869:	e9 c2 da ff ff       	jmp    80104330 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
8010686e:	c7 04 24 6d 7a 10 80 	movl   $0x80107a6d,(%esp)
...
801068c3:	e8 88 fb ff ff       	call   80106450 <walkpgdir>
...
801068fd:	e8 6e b0 ff ff       	call   80101970 <readi>
...
80106921:	c3                   	ret    
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
80106922:	c7 04 24 87 7a 10 80 	movl   $0x80107a87,(%esp)
80106929:	e8 32 9a ff ff       	call   80100360 <panic>
{
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
8010692e:	c7 04 24 34 7b 10 80 	movl   $0x80107b34,(%esp)
...
8010694e:	0f 88 8f 00 00 00    	js     801069e3 <allocuvm+0xa3>
    return 0;
  if(newsz < oldsz)
...
80106957:	8b 45 0c             	mov    0xc(%ebp),%eax
  ...
  if(newsz >= KERNBASE)
    return 0;
  if(newsz < oldsz)
8010695a:	0f 82 85 00 00 00    	jb     801069e5 <allocuvm+0xa5>
    return oldsz;

  a = PGROUNDUP(oldsz);
80106960:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80106966:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
8010696c:	39 df                	cmp    %ebx,%edi
8010696e:	77 57                	ja     801069c7 <allocuvm+0x87>
80106970:	eb 7e                	jmp    801069f0 <allocuvm+0xb0>
80106972:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    memset(mem, 0, PGSIZE);
80106978:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010697f:	00 
80106980:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106987:	00 
80106988:	89 04 24             	mov    %eax,(%esp)
8010698b:	e8 00 d9 ff ff       	call   80104290 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106990:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80106996:	89 44 24 0c          	mov    %eax,0xc(%esp)
8010699a:	8b 45 08             	mov    0x8(%ebp),%eax
8010699d:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801069a4:	00 
801069a5:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801069ac:	00 
801069ad:	89 5c 24 04          	mov    %ebx,0x4(%esp)
801069b1:	89 04 24             	mov    %eax,(%esp)
801069b4:	e8 87 fc ff ff       	call   80106640 <mappages>
801069b9:	85 c0                	test   %eax,%eax
801069bb:	78 43                	js     80106a00 <allocuvm+0xc0>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
801069bd:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801069c3:	39 df                	cmp    %ebx,%edi
801069c5:	76 29                	jbe    801069f0 <allocuvm+0xb0>
    mem = kalloc();
801069c7:	e8 e4 ba ff ff       	call   801024b0 <kalloc>
    if(mem == 0){
801069cc:	85 c0                	test   %eax,%eax
  ...
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
801069ce:	89 c6                	mov    %eax,%esi
    if(mem == 0){
801069d0:	75 a6                	jne    80106978 <allocuvm+0x38>
      cprintf("allocuvm out of memory\n");
801069d2:	c7 04 24 a5 7a 10 80 	movl   $0x80107aa5,(%esp)
801069d9:	e8 72 9c ff ff       	call   80100650 <cprintf>
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  pte_t *pte;
  uint a, pa;
  ...
  if(newsz >= oldsz)
801069de:	3b 7d 0c             	cmp    0xc(%ebp),%edi
801069e1:	77 47                	ja     80106a2a <allocuvm+0xea>
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
...
801069e5:	83 c4 2c             	add    $0x2c,%esp
801069e8:	5b                   	pop    %ebx
801069e9:	5e                   	pop    %esi
801069ea:	5f                   	pop    %edi
801069eb:	5d                   	pop    %ebp
...
801069fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
80106a00:	c7 04 24 bd 7a 10 80 	movl   $0x80107abd,(%esp)
...
80106a0f:	76 0d                	jbe    80106a1e <allocuvm+0xde>
80106a11:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106a14:	89 fa                	mov    %edi,%edx
80106a16:	8b 45 08             	mov    0x8(%ebp),%eax
80106a19:	e8 c2 fa ff ff       	call   801064e0 <deallocuvm.part.0>
    }
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
...
80106a28:	eb bb                	jmp    801069e5 <allocuvm+0xa5>
80106a2a:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106a2d:	89 fa                	mov    %edi,%edx
80106a2f:	8b 45 08             	mov    0x8(%ebp),%eax
80106a32:	e8 a9 fa ff ff       	call   801064e0 <deallocuvm.part.0>
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
    if(mem == 0){
      cprintf("allocuvm out of memory\n");
...
80106a39:	eb aa                	jmp    801069e5 <allocuvm+0xa5>
80106a3b:	90                   	nop
...
80106a50:	5d                   	pop    %ebp
80106a51:	e9 8a fa ff ff       	jmp    801064e0 <deallocuvm.part.0>
...
80106a7a:	e8 61 fa ff ff       	call   801064e0 <deallocuvm.part.0>
...
freevm(pde_t *pgdir)
{
  ...
  if(pgdir == 0)
    panic("freevm: no pgdir");
80106ac8:	c7 04 24 d9 7a 10 80 	movl   $0x80107ad9,(%esp)
...
80106ae5:	83 ec 20             	sub    $0x20,%esp
  pde_t *pgdir;
  struct kmap *k;
...
80106af1:	74 75                	je     80106b68 <setupkvm+0x88>
    return 0;
...
80106b0b:	e8 80 d7 ff ff       	call   80104290 <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
...
80106b16:	89 34 24             	mov    %esi,(%esp)
80106b19:	89 54 24 10          	mov    %edx,0x10(%esp)
80106b1d:	8b 53 08             	mov    0x8(%ebx),%edx
80106b20:	89 44 24 0c          	mov    %eax,0xc(%esp)
80106b24:	29 c2                	sub    %eax,%edx
80106b26:	8b 03                	mov    (%ebx),%eax
80106b28:	89 54 24 08          	mov    %edx,0x8(%esp)
80106b2c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b30:	e8 0b fb ff ff       	call   80106640 <mappages>
80106b35:	85 c0                	test   %eax,%eax
80106b37:	78 17                	js     80106b50 <setupkvm+0x70>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106b39:	83 c3 10             	add    $0x10,%ebx
80106b3c:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
80106b42:	72 cc                	jb     80106b10 <setupkvm+0x30>
...
80106b46:	83 c4 20             	add    $0x20,%esp
80106b49:	5b                   	pop    %ebx
80106b4a:	5e                   	pop    %esi
80106b4b:	5d                   	pop    %ebp
80106b4c:	c3                   	ret    
...
80106b53:	e8 08 ff ff ff       	call   80106a60 <freevm>
      return 0;
    }
  return pgdir;
}
...
80106b61:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
{
  ...
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
80106b68:	31 c0                	xor    %eax,%eax
80106b6a:	eb da                	jmp    80106b46 <setupkvm+0x66>
...
80106b9e:	e8 ad f8 ff ff       	call   80106450 <walkpgdir>
  if(pte == 0)
...
clearpteu(pde_t *pgdir, char *uva)
{
  ...
  if(pte == 0)
    panic("clearpteu");
80106bac:	c7 04 24 ea 7a 10 80 	movl   $0x80107aea,(%esp)
...
80106bce:	e8 7d f8 ff ff       	call   80106450 <walkpgdir>
  if (pte == 0)
80106bd3:	85 c0                	test   %eax,%eax
80106bd5:	74 05                	je     80106bdc <givepteu+0x1c>
    panic("givepteu");
  *pte |= PTE_U;
80106bd7:	83 08 04             	orl    $0x4,(%eax)
}
80106bda:	c9                   	leave  
80106bdb:	c3                   	ret    
givepteu(pde_t *pgdir, char *uva)
{
  ...
  if (pte == 0)
    panic("givepteu");
80106bdc:	c7 04 24 f4 7a 10 80 	movl   $0x80107af4,(%esp)
...
80106bf6:	83 ec 2c             	sub    $0x2c,%esp
  ...
  uint pa, i, flags;
  struct proc *curproc = myproc();
80106bf9:	e8 b2 ca ff ff       	call   801036b0 <myproc>
80106bfe:	89 45 dc             	mov    %eax,-0x24(%ebp)
  char *mem;

  if((d = setupkvm()) == 0)
80106c01:	e8 da fe ff ff       	call   80106ae0 <setupkvm>
80106c06:	85 c0                	test   %eax,%eax
80106c08:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106c0b:	0f 84 67 01 00 00    	je     80106d78 <copyuvm+0x188>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106c11:	8b 45 0c             	mov    0xc(%ebp),%eax
80106c14:	85 c0                	test   %eax,%eax
80106c16:	0f 84 ac 00 00 00    	je     80106cc8 <copyuvm+0xd8>
80106c1c:	31 db                	xor    %ebx,%ebx
80106c1e:	eb 51                	jmp    80106c71 <copyuvm+0x81>
...
80106c20:	81 c7 00 00 00 80    	add    $0x80000000,%edi
80106c26:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106c2d:	00 
80106c2e:	89 7c 24 04          	mov    %edi,0x4(%esp)
80106c32:	89 04 24             	mov    %eax,(%esp)
80106c35:	e8 f6 d6 ff ff       	call   80104330 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106c3a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106c3d:	8d 96 00 00 00 80    	lea    -0x80000000(%esi),%edx
80106c43:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106c47:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106c4e:	00 
80106c4f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106c53:	89 44 24 10          	mov    %eax,0x10(%esp)
80106c57:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106c5a:	89 04 24             	mov    %eax,(%esp)
80106c5d:	e8 de f9 ff ff       	call   80106640 <mappages>
80106c62:	85 c0                	test   %eax,%eax
80106c64:	78 4d                	js     80106cb3 <copyuvm+0xc3>
  struct proc *curproc = myproc();
  char *mem;
...
80106c6c:	39 5d 0c             	cmp    %ebx,0xc(%ebp)
80106c6f:	76 57                	jbe    80106cc8 <copyuvm+0xd8>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106c71:	8b 45 08             	mov    0x8(%ebp),%eax
80106c74:	31 c9                	xor    %ecx,%ecx
80106c76:	89 da                	mov    %ebx,%edx
80106c78:	e8 d3 f7 ff ff       	call   80106450 <walkpgdir>
80106c7d:	85 c0                	test   %eax,%eax
80106c7f:	0f 84 06 01 00 00    	je     80106d8b <copyuvm+0x19b>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106c85:	8b 30                	mov    (%eax),%esi
80106c87:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106c8d:	0f 84 ec 00 00 00    	je     80106d7f <copyuvm+0x18f>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106c93:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106c95:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106c9b:	89 75 e4             	mov    %esi,-0x1c(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106c9e:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106ca4:	e8 07 b8 ff ff       	call   801024b0 <kalloc>
80106ca9:	85 c0                	test   %eax,%eax
80106cab:	89 c6                	mov    %eax,%esi
80106cad:	0f 85 6d ff ff ff    	jne    80106c20 <copyuvm+0x30>
      goto bad;
  }
  return d;
...
bad:
  freevm(d);
80106cb3:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106cb6:	89 04 24             	mov    %eax,(%esp)
80106cb9:	e8 a2 fd ff ff       	call   80106a60 <freevm>
  return 0;
80106cbe:	31 c0                	xor    %eax,%eax
}
...
80106cc8:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106ccb:	8b 58 04             	mov    0x4(%eax),%ebx
80106cce:	f7 db                	neg    %ebx
80106cd0:	c1 e3 0c             	shl    $0xc,%ebx
80106cd3:	81 c3 00 f0 ff 7f    	add    $0x7ffff000,%ebx
80106cd9:	79 53                	jns    80106d2e <copyuvm+0x13e>
80106cdb:	e9 8d 00 00 00       	jmp    80106d6d <copyuvm+0x17d>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
80106ce0:	81 c7 00 00 00 80    	add    $0x80000000,%edi
80106ce6:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106ced:	00 
80106cee:	89 7c 24 04          	mov    %edi,0x4(%esp)
80106cf2:	89 04 24             	mov    %eax,(%esp)
80106cf5:	e8 36 d6 ff ff       	call   80104330 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106cfa:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106cfd:	8d 96 00 00 00 80    	lea    -0x80000000(%esi),%edx
80106d03:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106d07:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106d0e:	00 
80106d0f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106d13:	89 44 24 10          	mov    %eax,0x10(%esp)
80106d17:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106d1a:	89 04 24             	mov    %eax,(%esp)
80106d1d:	e8 1e f9 ff ff       	call   80106640 <mappages>
80106d22:	85 c0                	test   %eax,%eax
80106d24:	78 8d                	js     80106cb3 <copyuvm+0xc3>
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
      goto bad;
  ...
  for(i = KERNBASE - ((curproc->pgcount + 1)* PGSIZE); i < KERNBASE; i += PGSIZE){
80106d26:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106d2c:	78 3f                	js     80106d6d <copyuvm+0x17d>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106d2e:	8b 45 08             	mov    0x8(%ebp),%eax
80106d31:	31 c9                	xor    %ecx,%ecx
80106d33:	89 da                	mov    %ebx,%edx
80106d35:	e8 16 f7 ff ff       	call   80106450 <walkpgdir>
80106d3a:	85 c0                	test   %eax,%eax
80106d3c:	74 4d                	je     80106d8b <copyuvm+0x19b>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106d3e:	8b 30                	mov    (%eax),%esi
80106d40:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106d46:	74 37                	je     80106d7f <copyuvm+0x18f>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106d48:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106d4a:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106d50:	89 75 e4             	mov    %esi,-0x1c(%ebp)
  for(i = KERNBASE - ((curproc->pgcount + 1)* PGSIZE); i < KERNBASE; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106d53:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106d59:	e8 52 b7 ff ff       	call   801024b0 <kalloc>
80106d5e:	85 c0                	test   %eax,%eax
80106d60:	89 c6                	mov    %eax,%esi
80106d62:	0f 85 78 ff ff ff    	jne    80106ce0 <copyuvm+0xf0>
80106d68:	e9 46 ff ff ff       	jmp    80106cb3 <copyuvm+0xc3>
...
80106d7a:	e9 41 ff ff ff       	jmp    80106cc0 <copyuvm+0xd0>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
80106d7f:	c7 04 24 17 7b 10 80 	movl   $0x80107b17,(%esp)
80106d86:	e8 d5 95 ff ff       	call   80100360 <panic>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
80106d8b:	c7 04 24 fd 7a 10 80 	movl   $0x80107afd,(%esp)
80106d92:	e8 c9 95 ff ff       	call   80100360 <panic>
...
80106dae:	e8 9d f6 ff ff       	call   80106450 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106e1c:	e8 0f d5 ff ff       	call   80104330 <memmove>
    len -= n;
    buf += n;
...
80106e76:	c7 44 24 04 58 7b 10 	movl   $0x80107b58,0x4(%esp)
80106e7d:	80 
80106e7e:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106e85:	e8 d6 d1 ff ff       	call   80104060 <initlock>
  acquire(&(shm_table.lock));
80106e8a:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106e91:	e8 ba d2 ff ff       	call   80104150 <acquire>
80106e96:	b8 f4 55 11 80       	mov    $0x801155f4,%eax
80106e9b:	90                   	nop
80106e9c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for (i = 0; i< 64; i++) {
    shm_table.shm_pages[i].id =0;
80106ea0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80106ea6:	83 c0 0c             	add    $0xc,%eax
    shm_table.shm_pages[i].frame =0;
80106ea9:	c7 40 f8 00 00 00 00 	movl   $0x0,-0x8(%eax)
    shm_table.shm_pages[i].refcnt =0;
80106eb0:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
...
void shminit() {
  ...
  acquire(&(shm_table.lock));
  for (i = 0; i< 64; i++) {
80106eb7:	3d f4 58 11 80       	cmp    $0x801158f4,%eax
80106ebc:	75 e2                	jne    80106ea0 <shminit+0x30>
    shm_table.shm_pages[i].id =0;
    shm_table.shm_pages[i].frame =0;
    shm_table.shm_pages[i].refcnt =0;
  }
  release(&(shm_table.lock));
80106ebe:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106ec5:	e8 76 d3 ff ff       	call   80104240 <release>
}
80106eca:	c9                   	leave  
80106ecb:	c3                   	ret    
...
80106ed9:	8b 7d 08             	mov    0x8(%ebp),%edi
int i;
struct proc *curproc = myproc();
80106edc:	e8 cf c7 ff ff       	call   801036b0 <myproc>

acquire(&shm_table.lock);
80106ee1:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
  release(&(shm_table.lock));
}
...
acquire(&shm_table.lock);
80106eea:	e8 61 d2 ff ff       	call   80104150 <acquire>
80106eef:	b9 f4 55 11 80       	mov    $0x801155f4,%ecx
for(i = 0; i < 63; ++i)
80106ef4:	31 d2                	xor    %edx,%edx
80106ef6:	eb 0b                	jmp    80106f03 <shm_open+0x33>
80106ef8:	83 c2 01             	add    $0x1,%edx
80106efb:	83 c1 0c             	add    $0xc,%ecx
80106efe:	83 fa 3f             	cmp    $0x3f,%edx
80106f01:	74 6d                	je     80106f70 <shm_open+0xa0>
{
  if(shm_table.shm_pages[i].id == id)
80106f03:	3b 39                	cmp    (%ecx),%edi
80106f05:	75 f1                	jne    80106ef8 <shm_open+0x28>
  {
    if(mappages(curproc->pgdir, (char*)curproc->sz, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U) < 0)
80106f07:	8d 34 52             	lea    (%edx,%edx,2),%esi
80106f0a:	c1 e6 02             	shl    $0x2,%esi
80106f0d:	8b 86 f8 55 11 80    	mov    -0x7feeaa08(%esi),%eax
80106f13:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106f1a:	00 
80106f1b:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106f22:	00 
80106f23:	05 00 00 00 80       	add    $0x80000000,%eax
80106f28:	89 44 24 0c          	mov    %eax,0xc(%esp)
80106f2c:	8b 03                	mov    (%ebx),%eax
80106f2e:	89 44 24 04          	mov    %eax,0x4(%esp)
80106f32:	8b 43 08             	mov    0x8(%ebx),%eax
80106f35:	89 04 24             	mov    %eax,(%esp)
80106f38:	e8 03 f7 ff ff       	call   80106640 <mappages>
80106f3d:	85 c0                	test   %eax,%eax
80106f3f:	0f 88 fd 00 00 00    	js     80107042 <shm_open+0x172>
    {
      cprintf("Error\n");
      release(&shm_table.lock);
      return -1;
...
80106f45:	83 86 fc 55 11 80 01 	addl   $0x1,-0x7feeaa04(%esi)
    *pointer = (char*)curproc->sz;
80106f4c:	8b 03                	mov    (%ebx),%eax
80106f4e:	8b 75 0c             	mov    0xc(%ebp),%esi
80106f51:	89 06                	mov    %eax,(%esi)
    curproc->sz += PGSIZE;
80106f53:	81 03 00 10 00 00    	addl   $0x1000,(%ebx)
    release(&shm_table.lock);
80106f59:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106f60:	e8 db d2 ff ff       	call   80104240 <release>
    return 0;
80106f65:	31 c0                	xor    %eax,%eax
    return 0;
  }
  release(&shm_table.lock);
}
...
80106f67:	83 c4 2c             	add    $0x2c,%esp
80106f6a:	5b                   	pop    %ebx
80106f6b:	5e                   	pop    %esi
80106f6c:	5f                   	pop    %edi
80106f6d:	5d                   	pop    %ebp
...
acquire(&shm_table.lock);
for(i = 0; i < 63; ++i)
80106f70:	31 f6                	xor    %esi,%esi
80106f72:	eb 1c                	jmp    80106f90 <shm_open+0xc0>
80106f74:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  release(&shm_table.lock);
80106f78:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
    curproc->sz += PGSIZE;
    release(&shm_table.lock);
    return 0;
  }
...
80106f7f:	83 c6 01             	add    $0x1,%esi
  ...
  release(&shm_table.lock);
80106f82:	e8 b9 d2 ff ff       	call   80104240 <release>
    curproc->sz += PGSIZE;
    release(&shm_table.lock);
    return 0;
  }
...
for(i = 0; i < 63; ++i)
80106f87:	83 fe 3f             	cmp    $0x3f,%esi
80106f8a:	0f 84 ab 00 00 00    	je     8010703b <shm_open+0x16b>
80106f90:	8d 04 76             	lea    (%esi,%esi,2),%eax
80106f93:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
{
  if(shm_table.shm_pages[i].id == 0)
80106f9a:	8b 04 85 f4 55 11 80 	mov    -0x7feeaa0c(,%eax,4),%eax
80106fa1:	85 c0                	test   %eax,%eax
80106fa3:	75 d3                	jne    80106f78 <shm_open+0xa8>
  {
    shm_table.shm_pages[i].id = id;
80106fa5:	89 ba f4 55 11 80    	mov    %edi,-0x7feeaa0c(%edx)
80106fab:	89 55 e4             	mov    %edx,-0x1c(%ebp)
    shm_table.shm_pages[i].frame = kalloc();
80106fae:	e8 fd b4 ff ff       	call   801024b0 <kalloc>
80106fb3:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    memset(shm_table.shm_pages[i].frame,0, PGSIZE);
80106fb6:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106fbd:	00 
80106fbe:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106fc5:	00 
for(i = 0; i < 63; ++i)
{
  if(shm_table.shm_pages[i].id == 0)
  {
    shm_table.shm_pages[i].id = id;
    shm_table.shm_pages[i].frame = kalloc();
80106fc6:	8d b2 c8 55 11 80    	lea    -0x7feeaa38(%edx),%esi
    memset(shm_table.shm_pages[i].frame,0, PGSIZE);
...
for(i = 0; i < 63; ++i)
{
  if(shm_table.shm_pages[i].id == 0)
  {
    shm_table.shm_pages[i].id = id;
    shm_table.shm_pages[i].frame = kalloc();
80106fcf:	89 82 f8 55 11 80    	mov    %eax,-0x7feeaa08(%edx)
    memset(shm_table.shm_pages[i].frame,0, PGSIZE);
80106fd5:	e8 b6 d2 ff ff       	call   80104290 <memset>
    shm_table.shm_pages[i].refcnt = 1;
80106fda:	8b 55 e4             	mov    -0x1c(%ebp),%edx

    if(mappages(curproc->pgdir, (char*)curproc->sz, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U) < 0)
80106fdd:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106fe4:	00 
  if(shm_table.shm_pages[i].id == 0)
  {
    shm_table.shm_pages[i].id = id;
    ...
    memset(shm_table.shm_pages[i].frame,0, PGSIZE);
    shm_table.shm_pages[i].refcnt = 1;
80106fe5:	c7 82 fc 55 11 80 01 	movl   $0x1,-0x7feeaa04(%edx)
80106fec:	00 00 00 

    if(mappages(curproc->pgdir, (char*)curproc->sz, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U) < 0)
80106fef:	8b 46 30             	mov    0x30(%esi),%eax
80106ff2:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106ff9:	00 
80106ffa:	05 00 00 00 80       	add    $0x80000000,%eax
80106fff:	89 44 24 0c          	mov    %eax,0xc(%esp)
80107003:	8b 03                	mov    (%ebx),%eax
80107005:	89 44 24 04          	mov    %eax,0x4(%esp)
80107009:	8b 43 08             	mov    0x8(%ebx),%eax
8010700c:	89 04 24             	mov    %eax,(%esp)
8010700f:	e8 2c f6 ff ff       	call   80106640 <mappages>
80107014:	85 c0                	test   %eax,%eax
80107016:	78 2a                	js     80107042 <shm_open+0x172>
    {
      cprintf("Error\n");
      release(&shm_table.lock);
      return -1;
    ...
    *pointer = (char*)curproc->sz;
80107018:	8b 03                	mov    (%ebx),%eax
8010701a:	8b 7d 0c             	mov    0xc(%ebp),%edi
8010701d:	89 07                	mov    %eax,(%edi)
    curproc->sz += PGSIZE;
8010701f:	81 03 00 10 00 00    	addl   $0x1000,(%ebx)
    release(&shm_table.lock);
80107025:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
8010702c:	e8 0f d2 ff ff       	call   80104240 <release>
    return 0;
  }
  release(&shm_table.lock);
}
...
80107031:	83 c4 2c             	add    $0x2c,%esp
      return -1;
    }
    *pointer = (char*)curproc->sz;
    curproc->sz += PGSIZE;
...
8010703d:	e9 25 ff ff ff       	jmp    80106f67 <shm_open+0x97>
{
  if(shm_table.shm_pages[i].id == id)
  {
    if(mappages(curproc->pgdir, (char*)curproc->sz, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U) < 0)
    {
      cprintf("Error\n");
80107042:	c7 04 24 61 7b 10 80 	movl   $0x80107b61,(%esp)
80107049:	e8 02 96 ff ff       	call   80100650 <cprintf>
      release(&shm_table.lock);
8010704e:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80107055:	e8 e6 d1 ff ff       	call   80104240 <release>
      return -1;
8010705a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010705f:	e9 03 ff ff ff       	jmp    80106f67 <shm_open+0x97>
...
80107075:	bb f4 55 11 80       	mov    $0x801155f4,%ebx
8010707a:	83 ec 10             	sub    $0x10,%esp
8010707d:	8b 75 08             	mov    0x8(%ebp),%esi
int i;

acquire(&shm_table.lock);
80107080:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80107087:	e8 c4 d0 ff ff       	call   80104150 <acquire>
8010708c:	eb 0d                	jmp    8010709b <shm_close+0x2b>
8010708e:	66 90                	xchg   %ax,%ax
80107090:	83 c3 0c             	add    $0xc,%ebx
for(i = 0; i < 63; ++i)
80107093:	81 fb e8 58 11 80    	cmp    $0x801158e8,%ebx
80107099:	74 29                	je     801070c4 <shm_close+0x54>
{
  if(shm_table.shm_pages[i].id == id)
8010709b:	3b 33                	cmp    (%ebx),%esi
8010709d:	75 f1                	jne    80107090 <shm_close+0x20>
  {
    if(shm_table.shm_pages[i].refcnt - 1 == 0)
8010709f:	8b 43 08             	mov    0x8(%ebx),%eax
801070a2:	83 f8 01             	cmp    $0x1,%eax
801070a5:	74 29                	je     801070d0 <shm_close+0x60>
      shm_table.shm_pages[i].refcnt = 0;
      release(&shm_table.lock);
    }
    else
    {
      shm_table.shm_pages[i].refcnt -= 1;
801070a7:	83 e8 01             	sub    $0x1,%eax
801070aa:	83 c3 0c             	add    $0xc,%ebx
801070ad:	89 43 fc             	mov    %eax,-0x4(%ebx)
      release(&shm_table.lock);
801070b0:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
801070b7:	e8 84 d1 ff ff       	call   80104240 <release>
...
acquire(&shm_table.lock);
for(i = 0; i < 63; ++i)
801070bc:	81 fb e8 58 11 80    	cmp    $0x801158e8,%ebx
801070c2:	75 d7                	jne    8010709b <shm_close+0x2b>
      release(&shm_table.lock);
    }
  }
}
...
801070cd:	8d 76 00             	lea    0x0(%esi),%esi
    if(shm_table.shm_pages[i].refcnt - 1 == 0)
    {
      ...
      shm_table.shm_pages[i].refcnt = 0;
      release(&shm_table.lock);
801070d0:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
{
  if(shm_table.shm_pages[i].id == id)
  {
    if(shm_table.shm_pages[i].refcnt - 1 == 0)
    {
      shm_table.shm_pages[i].id = 0;
801070d7:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
      shm_table.shm_pages[i].frame = 0;
801070dd:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
      shm_table.shm_pages[i].refcnt = 0;
801070e4:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
      release(&shm_table.lock);
801070eb:	e8 50 d1 ff ff       	call   80104240 <release>
801070f0:	eb 9e                	jmp    80107090 <shm_close+0x20>
