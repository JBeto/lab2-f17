...
int main(int argc, char *argv[])
{
   ...
   int pid=0;
   pid=fork();
    1009:	e8 bc 02 00 00       	call   12ca <fork>
   if(pid==0){
   ...
   printf(1, "address %x\n", &x);
    ...
    101a:	c7 44 24 04 d1 17 00 	movl   $0x17d1,0x4(%esp)
    1021:	00 
...
int main(int argc, char *argv[])
{
   ...
   int x=1;
    ...
    1030:	00 
   printf(1, "address %x\n", &x);
    1031:	e8 fa 03 00 00       	call   1430 <printf>
   test(1);
    1036:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    103d:	e8 1e 00 00 00       	call   1060 <test>
   //exec("null",0);
   exit();
    1042:	e8 8b 02 00 00       	call   12d2 <exit>
   }
   wait();
    1047:	e8 8e 02 00 00       	call   12da <wait>
   test(1);
    104c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1053:	e8 08 00 00 00       	call   1060 <test>
   exit();
    1058:	e8 75 02 00 00       	call   12d2 <exit>
...
int test(int n)
{
    ...
    1065:	83 ec 18             	sub    $0x18,%esp
   //if(n<100) 
   if(n<1000) {
    1068:	81 7d 08 e7 03 00 00 	cmpl   $0x3e7,0x8(%ebp)
    106f:	7e 07                	jle    1078 <test+0x18>
   printf(1, "%x\n", &n);
   test(n+1);
   return n;
   }
...
int test(int n)
{
   ...
   if(n<1000) {
   printf(1, "%x\n", &n);
    1078:	8d 45 08             	lea    0x8(%ebp),%eax
    107b:	89 44 24 08          	mov    %eax,0x8(%esp)
    107f:	c7 44 24 04 d9 17 00 	movl   $0x17d9,0x4(%esp)
    1086:	00 
    1087:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    108e:	e8 9d 03 00 00       	call   1430 <printf>
   test(n+1);
    1093:	8b 45 08             	mov    0x8(%ebp),%eax
    1096:	83 c0 01             	add    $0x1,%eax
    1099:	89 04 24             	mov    %eax,(%esp)
    109c:	e8 bf ff ff ff       	call   1060 <test>
   return n;
...
putc(int fd, char c)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    155f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
    1561:	b8 dd 17 00 00       	mov    $0x17dd,%eax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1621:	a1 c4 1a 00 00       	mov    0x1ac4,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  freep = p;
    1669:	a3 c4 1a 00 00       	mov    %eax,0x1ac4
}
    166e:	5b                   	pop    %ebx
    166f:	5e                   	pop    %esi
    1670:	5f                   	pop    %edi
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    1692:	a3 c4 1a 00 00       	mov    %eax,0x1ac4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    16bc:	8b 1d c4 1a 00 00    	mov    0x1ac4,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    16fb:	3b 15 c4 1a 00 00    	cmp    0x1ac4,%edx
...
morecore(uint nu)
{
  ...
  return freep;
    1732:	8b 15 c4 1a 00 00    	mov    0x1ac4,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1754:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
    1757:	89 15 c4 1a 00 00    	mov    %edx,0x1ac4
      return (void*)(p + 1);
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    176e:	c7 05 c4 1a 00 00 c8 	movl   $0x1ac8,0x1ac4
    1775:	1a 00 00 
    base.s.size = 0;
    1778:	ba c8 1a 00 00       	mov    $0x1ac8,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    177d:	c7 05 c8 1a 00 00 c8 	movl   $0x1ac8,0x1ac8
    1784:	1a 00 00 
    base.s.size = 0;
    1787:	c7 05 cc 1a 00 00 00 	movl   $0x0,0x1acc
    178e:	00 00 00 
